...
.method static e()Lokio/a;
    ...
    :cond_1
    invoke-direct {v1, v3, v4}, Lokio/a;->l(J)J
    ...
    iput-object v3, v0, Lokio/a;->f:Lokio/a;
...
.method private static declared-synchronized f(Lokio/a;)Z
    .locals 3
...
.method private static declared-synchronized m(Lokio/a;JZ)V
    .locals 6
    ...
    :goto_1
    invoke-direct {p0, v1, v2}, Lokio/a;->l(J)J
    ...
    invoke-direct {v3, v1, v2}, Lokio/a;->l(J)J
...
.method public final g()V
    ...
    invoke-virtual {p0}, Lokio/o;->d()J

    move-result-wide v0

    invoke-virtual {p0}, Lokio/o;->b()Z
    ...
    invoke-static {p0, v0, v1, v2}, Lokio/a;->m(Lokio/a;JZ)V
...
.method final h(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lokio/a;->k(Ljava/io/IOException;)Ljava/io/IOException;
...
.method public final j()Z
    ...
    invoke-static {p0}, Lokio/a;->f(Lokio/a;)Z
...
.method public final n(Lokio/m;)Lokio/m;
    .locals 1

    new-instance v0, Lokio/a$a;

    invoke-direct {v0, p0, p1}, Lokio/a$a;-><init>(Lokio/a;Lokio/m;)V

    return-object v0
.end method

.method public final o(Lokio/n;)Lokio/n;
    .locals 1

    new-instance v0, Lokio/a$b;

    invoke-direct {v0, p0, p1}, Lokio/a$b;-><init>(Lokio/a;Lokio/n;)V
