...
.field private static final b:Lc6/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc9/g0;->a:Ljava/util/Random;

    sget-object v0, Lc9/b0;->a:Lc9/b0;

    sput-object v0, Lc9/g0;->b:Lc6/b;
...
.method public static A(Lcom/google/protobuf/i;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lcom/google/protobuf/i;->i(I)B
...
.method public static synthetic a(Ljava/lang/RuntimeException;)V
    ...
    invoke-static {p0}, Lc9/g0;->v(Ljava/lang/RuntimeException;)V
...
.method public static synthetic b(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
    ...
    invoke-static {p0, p1}, Lc9/g0;->w(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
...
.method public static synthetic c(Ljava/util/Comparator;Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
    ...
    invoke-static {p0, p1, p2}, Lc9/g0;->x(Ljava/util/Comparator;Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
...
.method public static synthetic d(Lc6/j;)Ljava/lang/Void;
    .locals 0

    invoke-static {p0}, Lc9/g0;->y(Lc6/j;)Ljava/lang/Void;
...
.method public static g()Ljava/util/Comparator;
    ...
    sget-object v0, Lc9/f0;->o:Lc9/f0;
...
.method public static j(Lcom/google/protobuf/i;Lcom/google/protobuf/i;)I
    ...
    invoke-virtual {p0, v1}, Lcom/google/protobuf/i;->i(I)B

    move-result v2

    and-int/lit16 v2, v2, 0xff

    invoke-virtual {p1, v1}, Lcom/google/protobuf/i;->i(I)B
...
.method public static k(DD)I
    ...
    invoke-static {p0, p1, p2, p3}, Li7/a;->c(DD)I
...
.method public static m(JJ)I
    ...
    invoke-static {p0, p1, p2, p3}, Li7/a;->a(JJ)I
...
.method public static n(DJ)I
    ...
    invoke-static {p0, p1, p2, p3}, Li7/a;->b(DJ)I
...
.method private static o(Ljava/lang/Exception;)Ljava/lang/Exception;
    ...
    instance-of v0, p0, Lwb/k1;

    if-eqz v0, :cond_0

    check-cast p0, Lwb/k1;

    invoke-virtual {p0}, Lwb/k1;->a()Lwb/j1;

    move-result-object p0

    :goto_0
    invoke-static {p0}, Lc9/g0;->t(Lwb/j1;)Lcom/google/firebase/firestore/z;
    ...
    check-cast p0, Lwb/l1;

    invoke-virtual {p0}, Lwb/l1;->a()Lwb/j1;
...
.method public static p(Ljava/lang/RuntimeException;)V
    ...
    invoke-direct {v1, p0}, Lc9/c0;-><init>(Ljava/lang/RuntimeException;)V
...
.method public static q(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Comparator;Lc9/n;Lc9/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1, p0, p2, p3, p4}, Lc9/g0;->r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;Lc9/n;Lc9/n;)V

    return-void
.end method

.method private static r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;Lc9/n;Lc9/n;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_0
    invoke-static {p0}, Lc9/g0;->e(Ljava/util/Iterator;)Ljava/lang/Object;

    move-result-object v0

    :goto_0
    invoke-static {p1}, Lc9/g0;->e(Ljava/util/Iterator;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v1}, Lc9/n;->accept(Ljava/lang/Object;)V
    ...
    invoke-interface {p4, v0}, Lc9/n;->accept(Ljava/lang/Object;)V
...
.method public static s(Ljava/util/SortedSet;Ljava/util/SortedSet;Lc9/n;Lc9/n;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    :cond_0
    sget-object p0, Lc9/e0;->o:Lc9/e0;

    :goto_0
    invoke-static {v0, p1, p0, p2, p3}, Lc9/g0;->r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;Lc9/n;Lc9/n;)V

    return-void
.end method

.method public static t(Lwb/j1;)Lcom/google/firebase/firestore/z;
    .locals 3

    invoke-virtual {p0}, Lwb/j1;->c()Lwb/k1;
...
.method public static u(Ljava/util/Map;ILjava/util/Comparator;)Ljava/util/Map;
    ...
    new-instance p0, Lc9/d0;

    invoke-direct {p0, p2}, Lc9/d0;-><init>(Ljava/util/Comparator;)V
...
.method private static synthetic y(Lc6/j;)Ljava/lang/Void;
    .locals 3
    ...
    invoke-static {p0}, Lc9/g0;->o(Ljava/lang/Exception;)Ljava/lang/Exception;
