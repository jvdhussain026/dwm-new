...
.field private static final d:Lzb/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lzb/h;->b:Ljava/util/logging/Logger;
    ...
    sput-object v0, Lzb/h;->c:[Ljava/lang/String;

    invoke-static {}, Lzb/h;->d()Lzb/h;

    move-result-object v0

    sput-object v0, Lzb/h;->d:Lzb/h;
...
.method public constructor <init>(Ljava/security/Provider;)V
    ...
    iput-object p1, p0, Lzb/h;->a:Ljava/security/Provider;
...
.method public static b(Ljava/util/List;)[B
    ...
    :cond_0
    invoke-virtual {v3}, Lzb/i;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lokio/c;->U0(I)Lokio/c;
    ...
    :cond_1
    invoke-virtual {v0}, Lokio/c;->n0()[B
...
.method private static d()Lzb/h;
    .locals 12

    const-class v0, [B

    invoke-static {}, Lzb/h;->f()Ljava/security/Provider;
    ...
    invoke-direct {v4, v2, v6, v5}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V
    ...
    invoke-direct {v5, v2, v7, v6}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    new-instance v6, Lzb/g;

    new-array v7, v3, [Ljava/lang/Class;

    const-string v9, "getAlpnSelectedProtocol"

    invoke-direct {v6, v0, v9, v7}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V
    ...
    invoke-direct {v7, v2, v0, v9}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V
    ...
    :cond_1
    invoke-static {}, Lzb/h;->j()Z

    move-result v1

    if-eqz v1, :cond_2

    sget-object v1, Lzb/h$h;->p:Lzb/h$h;

    goto :goto_2

    :cond_2
    sget-object v1, Lzb/h$h;->q:Lzb/h$h;

    goto :goto_2

    :cond_3
    :goto_1
    sget-object v1, Lzb/h$h;->o:Lzb/h$h;

    :goto_2
    move-object v10, v1

    new-instance v11, Lzb/h$d;
    ...
    invoke-direct/range {v1 .. v9}, Lzb/h$d;-><init>(Lzb/g;Lzb/g;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Lzb/g;Lzb/g;Ljava/security/Provider;Lzb/h$h;)V
    ...
    invoke-direct {v5}, Lzb/h$a;-><init>()V
    ...
    new-instance v4, Lzb/h$b;

    invoke-direct {v4}, Lzb/h$b;-><init>()V
    ...
    new-instance v5, Lzb/h$c;

    invoke-direct {v5}, Lzb/h$c;-><init>()V
    ...
    new-instance v6, Lzb/h$e;

    invoke-direct {v6, v0, v4, v5, v2}, Lzb/h$e;-><init>(Ljava/security/Provider;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Lzb/h$a;)V
    :try_end_3
    ...
    new-instance v1, Lzb/h$f;

    move-object v4, v1

    move-object v10, v0

    invoke-direct/range {v4 .. v10}, Lzb/h$f;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;Ljava/security/Provider;)V
    :try_end_5
    ...
    invoke-direct {v1, v0}, Lzb/h;-><init>(Ljava/security/Provider;)V
...
.method public static e()Lzb/h;
    .locals 1

    sget-object v0, Lzb/h;->d:Lzb/h;
...
.method private static f()Ljava/security/Provider;
    ...
    sget-object v5, Lzb/h;->c:[Ljava/lang/String;
    ...
    sget-object v0, Lzb/h;->b:Ljava/util/logging/Logger;
...
.method private static j()Z
    ...
    sget-object v1, Lzb/h;->b:Ljava/util/logging/Logger;
...
.method public g()Ljava/security/Provider;
    ...
    iget-object v0, p0, Lzb/h;->a:Ljava/security/Provider;
