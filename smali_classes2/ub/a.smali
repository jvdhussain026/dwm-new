...
.method constructor <init>(Lub/b;)V
    ...
    iput-object p1, p0, Lub/a;->o:Lub/b;
...
.method private b(Lkb/k$d;Ljava/lang/String;)V
    .locals 1

    iget-object v0, p0, Lub/a;->o:Lub/b;

    invoke-virtual {v0, p2}, Lub/b;->a(Ljava/lang/String;)Z
...
.method private c(Lkb/k$d;)V
    .locals 1

    iget-object v0, p0, Lub/a;->o:Lub/b;

    invoke-virtual {v0}, Lub/b;->b()V
...
.method private d(Lkb/j;Lkb/k$d;Ljava/lang/String;)V
    .locals 7
    ...
    invoke-static {p1}, Lub/a;->a(Ljava/util/Map;)Landroid/os/Bundle;

    move-result-object v3

    iget-object v1, p0, Lub/a;->o:Lub/b;

    move-object v2, p3

    invoke-virtual/range {v1 .. v6}, Lub/b;->c(Ljava/lang/String;Landroid/os/Bundle;ZZZ)Lub/b$a;

    move-result-object p1

    sget-object v0, Lub/b$a;->p:Lub/b$a;
    ...
    invoke-interface {p2, p1, p3, v1}, Lkb/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    goto :goto_0

    :cond_0
    sget-object v0, Lub/b$a;->q:Lub/b$a;
    ...
    invoke-interface {p2, p3, p1, v1}, Lkb/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method e(Lkb/c;)V
    ...
    iget-object v0, p0, Lub/a;->p:Lkb/k;
    ...
    iput-object v0, p0, Lub/a;->p:Lkb/k;
...
.method f()V
    ...
    invoke-virtual {v0, v1}, Lkb/k;->e(Lkb/k$c;)V

    iput-object v1, p0, Lub/a;->p:Lkb/k;
...
.method public onMethodCall(Lkb/j;Lkb/k$d;)V
    ...
    :pswitch_0
    invoke-direct {p0, p2}, Lub/a;->c(Lkb/k$d;)V

    goto :goto_1

    :pswitch_1
    invoke-direct {p0, p2, v0}, Lub/a;->b(Lkb/k$d;Ljava/lang/String;)V

    goto :goto_1

    :pswitch_2
    invoke-direct {p0, p1, p2, v0}, Lub/a;->d(Lkb/j;Lkb/k$d;Ljava/lang/String;)V
