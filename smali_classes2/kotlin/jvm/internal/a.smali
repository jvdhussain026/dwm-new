...
.field private transient reflected:Lvc/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/a;->getReflected()Lvc/b;

    move-result-object v0

    invoke-interface {v0, p1}, Lvc/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lvc/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lvc/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/a;->reflected:Lvc/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/a;->computeReflected()Lvc/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/a;->reflected:Lvc/b;

    :cond_0
    return-object v0
.end method

.method protected abstract computeReflected()Lvc/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {v0}, Lvc/a;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Lvc/d;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/t;->c(Ljava/lang/Class;)Lvc/d;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lvc/b;->getParameters()Ljava/util/List;
...
.method protected getReflected()Lvc/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/a;->compute()Lvc/b;
...
.method public getReturnType()Lvc/i;
    ...
    invoke-interface {v0}, Lvc/b;->getReturnType()Lvc/i;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lvc/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lvc/j;
    .locals 1
    ...
    invoke-interface {v0}, Lvc/b;->getVisibility()Lvc/j;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Lvc/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Lvc/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Lvc/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Lvc/b;->isSuspend()Z
