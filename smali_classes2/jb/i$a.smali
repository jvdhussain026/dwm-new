...
.method constructor <init>(Ljb/i;)V
    ...
    iput-object p1, p0, Ljb/i$a;->o:Ljb/i;
...
.method public onMethodCall(Lkb/j;Lkb/k$d;)V
    ...
    iget-object v1, p0, Ljb/i$a;->o:Ljb/i;

    invoke-static {v1}, Ljb/i;->a(Ljb/i;)Ljb/i$h;
    ...
    :pswitch_0
    iget-object p1, p0, Ljb/i$a;->o:Ljb/i;

    invoke-static {p1}, Ljb/i;->a(Ljb/i;)Ljb/i$h;

    move-result-object p1

    invoke-interface {p1}, Ljb/i$h;->m()Z
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->g(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-static {p1}, Ljb/i$e;->d(Ljava/lang/String;)Ljb/i$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lkb/k$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Ljb/i$a;->o:Ljb/i;

    invoke-static {v2}, Ljb/i;->a(Ljb/i;)Ljb/i$h;

    move-result-object v2

    invoke-interface {v2, p1}, Ljb/i$h;->a(Ljb/i$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p1}, Ljb/i$h;->b()V
    :try_end_3
    ...
    invoke-static {v1, p1}, Ljb/i;->f(Ljb/i;Lorg/json/JSONObject;)Ljb/i$j;
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->j(Ljb/i$j;)V
    ...
    invoke-interface {p1}, Ljb/i$h;->k()V
    ...
    invoke-interface {p1}, Ljb/i$h;->i()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Ljb/i;->e(Ljb/i;Ljava/lang/String;)Ljb/i$k;
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->c(Ljb/i$k;)V
    ...
    invoke-static {v1, p1}, Ljb/i;->d(Ljb/i;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->e(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Ljb/i;->c(Ljb/i;Lorg/json/JSONObject;)Ljb/i$c;
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->h(Ljb/i$c;)V
    ...
    invoke-static {v1, p1}, Ljb/i;->b(Ljb/i;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->l(I)V
    ...
    invoke-static {p1}, Ljb/i$g;->d(Ljava/lang/String;)Ljb/i$g;
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->f(Ljb/i$g;)V
    ...
    invoke-static {p1}, Ljb/i$i;->d(Ljava/lang/String;)Ljb/i$i;
    ...
    invoke-interface {v1, p1}, Ljb/i$h;->d(Ljb/i$i;)V
