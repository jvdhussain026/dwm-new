...
# static fields
.field public static final d:Lnb/c;
...
.method private q(Ljava/util/Map;)Lcom/google/firebase/firestore/s;
    ...
    invoke-direct {p0, v3}, Lnb/c;->q(Ljava/util/Map;)Lcom/google/firebase/firestore/s;
...
.method private r(Ljava/nio/ByteBuffer;)Lcom/google/firebase/firestore/FirebaseFirestore;
    ...
    invoke-virtual {p0, p1}, Lkb/q;->f(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    sget-object v2, Lnb/x;->w:Ljava/util/HashMap;

    monitor-enter v2

    :try_start_0
    invoke-static {v0, v1}, Lnb/x;->H(Ljava/lang/String;Ljava/lang/String;)Lcom/google/firebase/firestore/FirebaseFirestore;
    ...
    :cond_0
    invoke-static {v0}, Lo7/f;->p(Ljava/lang/String;)Lo7/f;

    move-result-object v0

    invoke-static {v0, v1}, Lcom/google/firebase/firestore/FirebaseFirestore;->u(Lo7/f;Ljava/lang/String;)Lcom/google/firebase/firestore/FirebaseFirestore;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/google/firebase/firestore/FirebaseFirestore;->J(Lcom/google/firebase/firestore/a0;)V

    invoke-static {v0, v1}, Lnb/x;->k0(Lcom/google/firebase/firestore/FirebaseFirestore;Ljava/lang/String;)V
...
.method private s(Ljava/nio/ByteBuffer;)Lcom/google/firebase/firestore/v0;
    ...
    invoke-direct {p0, v0}, Lnb/c;->q(Ljava/util/Map;)Lcom/google/firebase/firestore/s;
    ...
    sget-object v3, Lcom/google/firebase/firestore/v0$b;->p:Lcom/google/firebase/firestore/v0$b;

    goto :goto_3

    :cond_11
    sget-object v3, Lcom/google/firebase/firestore/v0$b;->o:Lcom/google/firebase/firestore/v0$b;
...
.method private v(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/h;)V
    ...
    invoke-virtual {p0, p1, v0}, Lnb/c;->p(Ljava/io/ByteArrayOutputStream;Ljava/lang/Object;)V
...
.method private w(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/n;)V
    ...
    sget-object v1, Lnb/x;->x:Ljava/util/Map;
...
.method private y(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/x0;)V
    ...
    sget-object v4, Lnb/x;->x:Ljava/util/Map;
    ...
    invoke-virtual {p2}, Lcom/google/firebase/firestore/x0;->s()Lcom/google/firebase/firestore/a1;
    ...
    invoke-virtual {p0, p1, v1}, Lnb/c;->p(Ljava/io/ByteArrayOutputStream;Ljava/lang/Object;)V
...
.method protected g(BLjava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    :pswitch_0
    invoke-direct {p0, p2}, Lnb/c;->t(Ljava/nio/ByteBuffer;)Lcom/google/firebase/firestore/a0;
    ...
    :pswitch_1
    invoke-direct {p0, p2}, Lnb/c;->s(Ljava/nio/ByteBuffer;)Lcom/google/firebase/firestore/v0;
    ...
    :pswitch_2
    invoke-direct {p0, p2}, Lnb/c;->r(Ljava/nio/ByteBuffer;)Lcom/google/firebase/firestore/FirebaseFirestore;
    ...
    :pswitch_6
    invoke-static {p2}, Lkb/q;->e(Ljava/nio/ByteBuffer;)I
    ...
    invoke-direct {p1, v0, v1, p2}, Lo7/o;-><init>(JI)V
    ...
    invoke-direct {p0, p1}, Lnb/c;->u(Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    :pswitch_f
    invoke-static {p2}, Lkb/q;->d(Ljava/nio/ByteBuffer;)[B

    move-result-object p1

    invoke-static {p1}, Lcom/google/firebase/firestore/f;->l([B)Lcom/google/firebase/firestore/f;
    ...
    invoke-static {p2, p1}, Lkb/q;->c(Ljava/nio/ByteBuffer;I)V
...
.method protected p(Ljava/io/ByteArrayOutputStream;Ljava/lang/Object;)V
    ...
    invoke-static {p1, v0, v1}, Lkb/q;->n(Ljava/io/ByteArrayOutputStream;J)V
    ...
    invoke-static {p1, p2}, Lkb/q;->m(Ljava/io/ByteArrayOutputStream;I)V
    ...
    invoke-static {p1, v0}, Lkb/q;->h(Ljava/io/ByteArrayOutputStream;I)V

    check-cast p2, Lcom/google/firebase/firestore/d0;

    invoke-virtual {p2}, Lcom/google/firebase/firestore/d0;->j()D

    move-result-wide v0

    invoke-static {p1, v0, v1}, Lkb/q;->k(Ljava/io/ByteArrayOutputStream;D)V

    invoke-virtual {p2}, Lcom/google/firebase/firestore/d0;->l()D
    ...
    invoke-virtual {v0}, Lcom/google/firebase/firestore/FirebaseFirestore;->r()Lo7/f;
    ...
    invoke-virtual {p0, p1, p2}, Lnb/c;->p(Ljava/io/ByteArrayOutputStream;Ljava/lang/Object;)V

    sget-object v1, Lnb/x;->w:Ljava/util/HashMap;

    monitor-enter v1

    :try_start_0
    invoke-static {v0}, Lnb/x;->G(Lcom/google/firebase/firestore/FirebaseFirestore;)Lnb/b;

    move-result-object p2

    invoke-virtual {p2}, Lnb/b;->a()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Lnb/c;->w(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/n;)V
    ...
    invoke-direct {p0, p1, p2}, Lnb/c;->y(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/x0;)V
    ...
    invoke-direct {p0, p1, p2}, Lnb/c;->v(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/h;)V
    ...
    invoke-direct {p0, p1, p2}, Lnb/c;->x(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/i0;)V
    ...
    invoke-direct {p0, p1, p2}, Lnb/c;->z(Ljava/io/ByteArrayOutputStream;Lcom/google/firebase/firestore/a1;)V
    ...
    invoke-static {p1, p2}, Lkb/q;->i(Ljava/io/ByteArrayOutputStream;[B)V
