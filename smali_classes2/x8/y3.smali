...
# direct methods
.method constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Lx8/o;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;

    iput-object p2, p0, Lx8/y3;->b:Lx8/o;
...
.method private A()V
    ...
    new-instance v1, Lx8/j3;

    invoke-direct {v1, p0}, Lx8/j3;-><init>(Lx8/y3;)V

    invoke-direct {p0, v0, v1}, Lx8/y3;->N([Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method private B()V
    ...
    new-instance v1, Lx8/o3;

    invoke-direct {v1, p0}, Lx8/o3;-><init>(Lx8/y3;)V
...
.method private C()V
    ...
    new-instance v1, Lx8/h3;

    invoke-direct {v1, p0}, Lx8/h3;-><init>(Lx8/y3;)V
...
.method private D()V
    ...
    new-instance v1, Lx8/i3;

    invoke-direct {v1, p0}, Lx8/i3;-><init>(Lx8/y3;)V
...
.method private E()V
    ...
    new-instance v1, Lx8/k3;

    invoke-direct {v1, p0}, Lx8/k3;-><init>(Lx8/y3;)V
    ...
    iget-object v1, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v2, Lx8/q3;

    invoke-direct {v2, v0, v1}, Lx8/q3;-><init>(Lx8/t0$a;Landroid/database/sqlite/SQLiteStatement;)V

    new-instance v0, Lx8/z2$d;

    iget-object v1, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;

    const-string v3, "SELECT path FROM remote_documents"

    invoke-direct {v0, v1, v3}, Lx8/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Lx8/g3;

    invoke-direct {v1, v2}, Lx8/g3;-><init>(Lc9/n;)V
    ...
    new-instance v1, Lx8/p3;

    invoke-direct {v1, v2}, Lx8/p3;-><init>(Lc9/n;)V
...
.method private F()V
    ...
    invoke-direct {v0, v1, v2}, Lx8/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Lx8/r3;

    invoke-direct {v1, p0}, Lx8/r3;-><init>(Lx8/y3;)V
...
.method private G()V
    ...
    invoke-direct {p0, v0}, Lx8/y3;->m0(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method private H()V
    ...
    iget-object v2, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v3, Lx8/v3;

    invoke-direct {v3, v1, v2}, Lx8/v3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;)V

    invoke-virtual {v0, v3}, Lx8/z2$d;->e(Lc9/n;)I
...
.method private J()V
    ...
    sget-object v1, Lx8/x3;->a:Lx8/x3;
    ...
    new-instance v5, Lx8/z2$d;

    iget-object v6, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v5, v6, v7}, Lx8/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v6}, Lx8/z2$d;->b([Ljava/lang/Object;)Lx8/z2$d;
    ...
    new-instance v6, Lx8/w3;

    invoke-direct {v6, v1, v0, v3, v4}, Lx8/w3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;J)V

    invoke-virtual {v5, v6}, Lx8/z2$d;->e(Lc9/n;)I
...
.method private M()Z
    ...
    invoke-direct {p0, v0, v1}, Lx8/y3;->l0(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    const-string v2, "read_time_nanos"

    invoke-direct {p0, v0, v2}, Lx8/y3;->l0(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private N([Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, v4}, Lx8/y3;->m0(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p1, p2}, Lc9/v;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static synthetic V(Lx8/t0$a;Landroid/database/sqlite/SQLiteStatement;Ly8/u;)V
    .locals 1

    invoke-virtual {p0, p2}, Lx8/t0$a;->a(Ly8/u;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-virtual {p2}, Ly8/e;->o()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p2}, Ly8/e;->v()Ly8/e;
    ...
    invoke-static {p2}, Lx8/f;->c(Ly8/e;)Ljava/lang/String;
...
.method private static synthetic W(Lc9/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private static synthetic X(Lc9/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic Z(Landroid/database/Cursor;)V
    ...
    :try_start_0
    invoke-static {p1}, La9/c;->x0([B)La9/c;

    move-result-object p1

    invoke-virtual {p1}, Lcom/google/protobuf/z;->d0()Lcom/google/protobuf/z$a;

    move-result-object p1

    check-cast p1, La9/c$b;

    invoke-virtual {p1}, La9/c$b;->F()La9/c$b;
    ...
    iget-object v3, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method public static synthetic a(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->T()V
...
.method private static synthetic a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0}, Lx8/f;->b(Ljava/lang/String;)Ly8/u;

    move-result-object p2

    invoke-virtual {p1}, Landroid/database/sqlite/SQLiteStatement;->clearBindings()V

    invoke-virtual {p2}, Ly8/e;->t()I
    ...
    invoke-static {v1, p1, p0}, Lc9/b;->d(ZLjava/lang/String;[Ljava/lang/Object;)V

    return-void
.end method

.method public static synthetic b(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->U()V
...
.method public static synthetic c(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->R()V
...
.method public static synthetic d(Landroid/database/Cursor;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lx8/y3;->b0(Landroid/database/Cursor;)Ljava/lang/Long;
...
.method private synthetic d0(Ljava/lang/String;Landroid/database/Cursor;)V
    ...
    invoke-direct {p0, p1, p2}, Lx8/y3;->h0(Ljava/lang/String;I)V
...
.method public static synthetic e([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2}, Lx8/y3;->a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
...
.method private synthetic e0(Landroid/database/Cursor;)V
    ...
    new-instance p1, Lx8/z2$d;

    iget-object v5, p0, Lx8/y3;->a:Landroid/database/sqlite/SQLiteDatabase;

    const-string v6, "SELECT batch_id FROM mutations WHERE uid = ? AND batch_id <= ?"

    invoke-direct {p1, v5, v6}, Lx8/z2$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v5}, Lx8/z2$d;->b([Ljava/lang/Object;)Lx8/z2$d;

    move-result-object p1

    new-instance v0, Lx8/u3;

    invoke-direct {v0, p0, v1}, Lx8/u3;-><init>(Lx8/y3;Ljava/lang/String;)V

    invoke-virtual {p1, v0}, Lx8/z2$d;->e(Lc9/n;)I

    return-void
.end method

.method public static synthetic f(Lx8/t0$a;Landroid/database/sqlite/SQLiteStatement;Ly8/u;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lx8/y3;->V(Lx8/t0$a;Landroid/database/sqlite/SQLiteStatement;Ly8/u;)V
...
.method private synthetic f0(Landroid/database/Cursor;)V
    ...
    iget-object v3, p0, Lx8/y3;->b:Lx8/o;

    invoke-virtual {v3, p1}, Lx8/o;->h(La9/c;)Lx8/h4;
    ...
    invoke-virtual {p1}, Lv8/g1;->c()Ljava/lang/String;
...
.method public static synthetic g(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->Y()V
...
.method private g0()V
    ...
    new-instance v1, Lx8/t3;

    invoke-direct {v1, p0}, Lx8/t3;-><init>(Lx8/y3;)V
...
.method public static synthetic h(Lc9/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Lx8/y3;->W(Lc9/n;Landroid/database/Cursor;)V
...
.method private h0(Ljava/lang/String;I)V
    ...
    invoke-static {v0, v5, v3}, Lc9/b;->d(ZLjava/lang/String;[Ljava/lang/Object;)V
...
.method public static synthetic i(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->P()V
...
.method private i0()V
    ...
    new-instance v1, Lx8/s3;

    invoke-direct {v1, p0}, Lx8/s3;-><init>(Lx8/y3;)V
...
.method public static synthetic j(Lx8/y3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Lx8/y3;->Z(Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic k(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->O()V

    return-void
.end method

.method public static synthetic l(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->Q()V
...
.method private l0(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lx8/y3;->L(Ljava/lang/String;)Ljava/util/List;
...
.method public static synthetic m(Lx8/y3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Lx8/y3;->f0(Landroid/database/Cursor;)V
...
.method public static synthetic n(Lx8/y3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Lx8/y3;->e0(Landroid/database/Cursor;)V
...
.method public static synthetic o([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lx8/y3;->c0([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic p(Lx8/y3;Ljava/lang/String;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lx8/y3;->d0(Ljava/lang/String;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic q(Lc9/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Lx8/y3;->X(Lc9/n;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic r(Lx8/y3;)V
    .locals 0

    invoke-direct {p0}, Lx8/y3;->S()V
...
.method private x()V
    ...
    new-instance v1, Lx8/m3;

    invoke-direct {v1, p0}, Lx8/m3;-><init>(Lx8/y3;)V
...
.method private y()V
    ...
    new-instance v1, Lx8/l3;

    invoke-direct {v1, p0}, Lx8/l3;-><init>(Lx8/y3;)V
...
.method private z()V
    ...
    new-instance v1, Lx8/n3;

    invoke-direct {v1, p0}, Lx8/n3;-><init>(Lx8/y3;)V
...
.method j0(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lx8/y3;->k0(II)V
...
.method k0(II)V
    ...
    invoke-direct {p0}, Lx8/y3;->B()V

    invoke-direct {p0}, Lx8/y3;->D()V

    invoke-direct {p0}, Lx8/y3;->C()V
    ...
    invoke-direct {p0}, Lx8/y3;->K()V

    invoke-direct {p0}, Lx8/y3;->w()V
    ...
    invoke-direct {p0}, Lx8/y3;->A()V

    invoke-direct {p0}, Lx8/y3;->y()V

    sget-object v4, Lx8/e1;->b:Ljava/lang/String;

    invoke-direct {p0, v4}, Lx8/y3;->t(Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v3}, Lc9/v;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
