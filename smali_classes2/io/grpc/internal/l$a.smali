...
.field private volatile d:Lwb/j1;

.field private e:Lwb/j1;

.field private f:Lwb/j1;
...
.method static synthetic e(Lio/grpc/internal/l$a;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 0
...
.method private j()V
    ...
    :cond_0
    iget-object v0, p0, Lio/grpc/internal/l$a;->e:Lwb/j1;

    iget-object v1, p0, Lio/grpc/internal/l$a;->f:Lwb/j1;

    const/4 v2, 0x0

    iput-object v2, p0, Lio/grpc/internal/l$a;->e:Lwb/j1;

    iput-object v2, p0, Lio/grpc/internal/l$a;->f:Lwb/j1;
    ...
    invoke-super {p0, v0}, Lio/grpc/internal/k0;->b(Lwb/j1;)V

    :cond_1
    if-eqz v1, :cond_2

    invoke-super {p0, v1}, Lio/grpc/internal/k0;->c(Lwb/j1;)V
...
.method public b(Lwb/j1;)V
    ...
    iput-object p1, p0, Lio/grpc/internal/l$a;->d:Lwb/j1;
    ...
    iput-object p1, p0, Lio/grpc/internal/l$a;->e:Lwb/j1;
    ...
    invoke-super {p0, p1}, Lio/grpc/internal/k0;->b(Lwb/j1;)V
...
.method public c(Lwb/j1;)V
    ...
    :cond_0
    iget-object v0, p0, Lio/grpc/internal/l$a;->f:Lwb/j1;
    ...
    iput-object p1, p0, Lio/grpc/internal/l$a;->f:Lwb/j1;
    ...
    invoke-super {p0, p1}, Lio/grpc/internal/k0;->c(Lwb/j1;)V
...
.method public g(Lwb/z0;Lwb/y0;Lwb/c;[Lwb/k;)Lio/grpc/internal/q;
    ...
    invoke-virtual {p3}, Lwb/c;->c()Lwb/b;
    ...
    invoke-static {v0}, Lio/grpc/internal/l;->a(Lio/grpc/internal/l;)Lwb/b;
    ...
    invoke-static {v1}, Lio/grpc/internal/l;->a(Lio/grpc/internal/l;)Lwb/b;
    ...
    invoke-static {v2}, Lio/grpc/internal/l;->a(Lio/grpc/internal/l;)Lwb/b;

    move-result-object v2

    invoke-direct {v1, v2, v0}, Lwb/m;-><init>(Lwb/b;Lwb/b;)V
    ...
    invoke-direct/range {v1 .. v7}, Lio/grpc/internal/n1;-><init>(Lio/grpc/internal/s;Lwb/z0;Lwb/y0;Lwb/c;Lio/grpc/internal/n1$a;[Lwb/k;)V
    ...
    iget-object p2, p0, Lio/grpc/internal/l$a;->d:Lwb/j1;

    invoke-direct {p1, p2, p4}, Lio/grpc/internal/f0;-><init>(Lwb/j1;[Lwb/k;)V
    ...
    invoke-direct {p2, p0, p1, p3}, Lio/grpc/internal/l$a$b;-><init>(Lio/grpc/internal/l$a;Lwb/z0;Lwb/c;)V

    :try_start_0
    instance-of p1, v0, Lwb/l0;

    if-eqz p1, :cond_3

    move-object p1, v0

    check-cast p1, Lwb/l0;

    invoke-interface {p1}, Lwb/l0;->a()Z

    move-result p1

    if-eqz p1, :cond_3

    invoke-virtual {p3}, Lwb/c;->e()Ljava/util/concurrent/Executor;
    ...
    :goto_1
    invoke-virtual {v0, p2, p1, v8}, Lwb/b;->a(Lwb/b$b;Ljava/util/concurrent/Executor;Lwb/b$a;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v8, p1}, Lio/grpc/internal/n1;->b(Lwb/j1;)V
