...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/j1$b;->g:Lwb/c$c;
...
.method constructor <init>(Ljava/util/Map;ZII)V
    ...
    invoke-static {p1}, Lio/grpc/internal/e2;->w(Ljava/util/Map;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/j1$b;->a:Ljava/lang/Long;

    invoke-static {p1}, Lio/grpc/internal/e2;->x(Ljava/util/Map;)Ljava/lang/Boolean;
    ...
    invoke-static {v3, v4, v0}, Lj7/k;->j(ZLjava/lang/String;Ljava/lang/Object;)V

    :cond_1
    invoke-static {p1}, Lio/grpc/internal/e2;->k(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {v1, v2, v0}, Lj7/k;->j(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lio/grpc/internal/e2;->r(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lio/grpc/internal/e2;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method private static a(Ljava/util/Map;I)Lio/grpc/internal/t0;
    ...
    invoke-static {p0}, Lio/grpc/internal/e2;->h(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {v3, v4, v0}, Lj7/k;->h(ZLjava/lang/String;I)V

    invoke-static {v0, p1}, Ljava/lang/Math;->min(II)I

    move-result p1

    invoke-static {p0}, Lio/grpc/internal/e2;->c(Ljava/util/Map;)Ljava/lang/Long;

    move-result-object v0

    const-string v3, "hedgingDelay cannot be empty"

    invoke-static {v0, v3}, Lj7/k;->o(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v0, v3, v4}, Lj7/k;->i(ZLjava/lang/String;J)V

    new-instance v0, Lio/grpc/internal/t0;

    invoke-static {p0}, Lio/grpc/internal/e2;->p(Ljava/util/Map;)Ljava/util/Set;
...
.method private static b(Ljava/util/Map;I)Lio/grpc/internal/a2;
    ...
    invoke-static {p0}, Lio/grpc/internal/e2;->e(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {v0, v3, v5, v6}, Lj7/k;->i(ZLjava/lang/String;J)V

    invoke-static {p0}, Lio/grpc/internal/e2;->j(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {v0, v3, v9, v10}, Lj7/k;->i(ZLjava/lang/String;J)V
    ...
    invoke-static {v0, v13, v3}, Lj7/k;->j(ZLjava/lang/String;Ljava/lang/Object;)V

    invoke-static {p0}, Lio/grpc/internal/e2;->q(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {v3, v7, v0}, Lj7/k;->j(ZLjava/lang/String;Ljava/lang/Object;)V

    invoke-static {p0}, Lio/grpc/internal/e2;->s(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {v1, v2}, Lj7/k;->e(ZLjava/lang/Object;)V
