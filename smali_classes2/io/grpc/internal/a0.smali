...
.field private j:Lwb/j1;

.field private k:Lwb/r0$i;

.field private l:J


# direct methods
.method constructor <init>(Ljava/util/concurrent/Executor;Lwb/n1;)V
    .locals 2
    ...
    invoke-static {v0, v1}, Lwb/j0;->a(Ljava/lang/Class;Ljava/lang/String;)Lwb/j0;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/a0;->a:Lwb/j0;
    ...
    iput-object p2, p0, Lio/grpc/internal/a0;->d:Lwb/n1;
...
.method static synthetic e(Lio/grpc/internal/a0;)Lwb/j1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->j:Lwb/j1;
...
.method static synthetic n(Lio/grpc/internal/a0;)Lwb/n1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->d:Lwb/n1;

    return-object p0
.end method

.method private o(Lwb/r0$f;[Lwb/k;)Lio/grpc/internal/a0$e;
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lio/grpc/internal/a0$e;-><init>(Lio/grpc/internal/a0;Lwb/r0$f;[Lwb/k;Lio/grpc/internal/a0$a;)V
    ...
    iget-object p1, p0, Lio/grpc/internal/a0;->d:Lwb/n1;

    iget-object p2, p0, Lio/grpc/internal/a0;->e:Ljava/lang/Runnable;

    invoke-virtual {p1, p2}, Lwb/n1;->b(Ljava/lang/Runnable;)V
...
# virtual methods
.method public final b(Lwb/j1;)V
    .locals 3
    ...
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/a0;->j:Lwb/j1;
    ...
    :cond_0
    iput-object p1, p0, Lio/grpc/internal/a0;->j:Lwb/j1;

    iget-object v1, p0, Lio/grpc/internal/a0;->d:Lwb/n1;

    new-instance v2, Lio/grpc/internal/a0$d;

    invoke-direct {v2, p0, p1}, Lio/grpc/internal/a0$d;-><init>(Lio/grpc/internal/a0;Lwb/j1;)V

    invoke-virtual {v1, v2}, Lwb/n1;->b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p1}, Lwb/n1;->b(Ljava/lang/Runnable;)V
...
.method public final c(Lwb/j1;)V
    .locals 6

    invoke-virtual {p0, p1}, Lio/grpc/internal/a0;->b(Lwb/j1;)V
    ...
    sget-object v4, Lio/grpc/internal/r$a;->p:Lio/grpc/internal/r$a;

    invoke-static {v1}, Lio/grpc/internal/a0$e;->y(Lio/grpc/internal/a0$e;)[Lwb/k;

    move-result-object v5

    invoke-direct {v3, p1, v4, v5}, Lio/grpc/internal/f0;-><init>(Lwb/j1;Lio/grpc/internal/r$a;[Lwb/k;)V
    ...
    invoke-virtual {p1, v2}, Lwb/n1;->execute(Ljava/lang/Runnable;)V
...
.method public final d(Lio/grpc/internal/k1$a;)Ljava/lang/Runnable;
    .locals 1
...
.method public f()Lwb/j0;
    ...
    iget-object v0, p0, Lio/grpc/internal/a0;->a:Lwb/j0;

    return-object v0
.end method

.method public final g(Lwb/z0;Lwb/y0;Lwb/c;[Lwb/k;)Lio/grpc/internal/q;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p3}, Lio/grpc/internal/t1;-><init>(Lwb/z0;Lwb/y0;Lwb/c;)V
    ...
    :try_start_1
    iget-object v3, p0, Lio/grpc/internal/a0;->j:Lwb/j1;

    if-eqz v3, :cond_0

    new-instance p1, Lio/grpc/internal/f0;

    iget-object p3, p0, Lio/grpc/internal/a0;->j:Lwb/j1;

    invoke-direct {p1, p3, p4}, Lio/grpc/internal/f0;-><init>(Lwb/j1;[Lwb/k;)V
    ...
    :goto_2
    iget-object p2, p0, Lio/grpc/internal/a0;->d:Lwb/n1;

    invoke-virtual {p2}, Lwb/n1;->a()V

    return-object p1

    :cond_0
    :try_start_2
    iget-object v3, p0, Lio/grpc/internal/a0;->k:Lwb/r0$i;

    if-nez v3, :cond_1

    invoke-direct {p0, v0, p4}, Lio/grpc/internal/a0;->o(Lwb/r0$f;[Lwb/k;)Lio/grpc/internal/a0$e;
    ...
    :try_start_3
    invoke-virtual {v3, v0}, Lwb/r0$i;->a(Lwb/r0$f;)Lwb/r0$e;

    move-result-object p1

    invoke-virtual {p3}, Lwb/c;->j()Z

    move-result p2

    invoke-static {p1, p2}, Lio/grpc/internal/r0;->j(Lwb/r0$e;Z)Lio/grpc/internal/s;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {v0}, Lwb/r0$f;->c()Lwb/z0;

    move-result-object p2

    invoke-virtual {v0}, Lwb/r0$f;->b()Lwb/y0;

    move-result-object p3

    invoke-virtual {v0}, Lwb/r0$f;->a()Lwb/c;

    move-result-object v0

    invoke-interface {p1, p2, p3, v0, p4}, Lio/grpc/internal/s;->g(Lwb/z0;Lwb/y0;Lwb/c;[Lwb/k;)Lio/grpc/internal/q;
...
.method final r(Lwb/r0$i;)V
    ...
    :try_start_0
    iput-object p1, p0, Lio/grpc/internal/a0;->k:Lwb/r0$i;
    ...
    invoke-static {v2}, Lio/grpc/internal/a0$e;->z(Lio/grpc/internal/a0$e;)Lwb/r0$f;

    move-result-object v3

    invoke-virtual {p1, v3}, Lwb/r0$i;->a(Lwb/r0$f;)Lwb/r0$e;
    ...
    invoke-virtual {v4}, Lwb/r0$f;->a()Lwb/c;

    move-result-object v4

    invoke-virtual {v4}, Lwb/c;->j()Z

    move-result v5

    invoke-static {v3, v5}, Lio/grpc/internal/r0;->j(Lwb/r0$e;Z)Lio/grpc/internal/s;
    ...
    invoke-virtual {v4}, Lwb/c;->e()Ljava/util/concurrent/Executor;
    ...
    iget-object v0, p0, Lio/grpc/internal/a0;->d:Lwb/n1;

    iget-object v1, p0, Lio/grpc/internal/a0;->f:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Lwb/n1;->b(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lio/grpc/internal/a0;->j:Lwb/j1;
    ...
    invoke-virtual {v1, v0}, Lwb/n1;->b(Ljava/lang/Runnable;)V
