...
.field private final b:Ljb/i;

.field private final c:Lio/flutter/plugin/platform/c$d;

.field private d:Ljb/i$j;

.field private e:I

.field final f:Ljb/i$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Ljb/i;Lio/flutter/plugin/platform/c$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/c;->f:Ljb/i$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/c;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/c;->b:Ljb/i;

    invoke-virtual {p2, v0}, Ljb/i;->l(Ljb/i$h;)V
...
.method static synthetic a(Lio/flutter/plugin/platform/c;Ljb/i$i;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->q(Ljb/i$i;)V
...
.method static synthetic e(Lio/flutter/plugin/platform/c;)Ljb/i;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/c;->b:Ljb/i;

    return-object p0
.end method

.method static synthetic f(Lio/flutter/plugin/platform/c;Ljb/i$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->u(Ljb/i$c;)V
...
.method static synthetic h(Lio/flutter/plugin/platform/c;Ljb/i$k;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->w(Ljb/i$k;)V
...
.method static synthetic k(Lio/flutter/plugin/platform/c;Ljb/i$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->z(Ljb/i$j;)V
...
.method static synthetic m(Lio/flutter/plugin/platform/c;Ljb/i$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/c;->p(Ljb/i$e;)Ljava/lang/CharSequence;
...
.method private p(Ljb/i$e;)Ljava/lang/CharSequence;
    .locals 4
    ...
    sget-object v1, Ljb/i$e;->p:Ljb/i$e;
    ...
    invoke-static {v0, v1, p1}, Lxa/b;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v2
.end method

.method private q(Ljb/i$i;)V
    .locals 1

    sget-object v0, Ljb/i$i;->p:Ljb/i$i;
...
.method private r()V
    ...
    invoke-interface {v0}, Landroidx/activity/h;->g()Landroidx/activity/OnBackPressedDispatcher;
...
.method private u(Ljb/i$c;)V
    ...
    iget-object v4, p1, Ljb/i$c;->b:Ljava/lang/String;

    const/4 v5, 0x0

    iget v6, p1, Ljb/i$c;->a:I
    ...
    iget-object v1, p1, Ljb/i$c;->b:Ljava/lang/String;

    const/4 v2, 0x0

    iget p1, p1, Ljb/i$c;->a:I
...
.method private w(Ljb/i$k;)V
    .locals 1

    sget-object v0, Ljb/i$k;->p:Ljb/i$k;
    ...
    :cond_0
    sget-object v0, Ljb/i$k;->q:Ljb/i$k;
    ...
    :cond_1
    sget-object v0, Ljb/i$k;->r:Ljb/i$k;
    ...
    :cond_2
    sget-object v0, Ljb/i$k;->s:Ljb/i$k;
...
.method private z(Ljb/i$j;)V
    ...
    invoke-direct {v2, v0, v1}, Landroidx/core/view/k0;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v3, p1, Ljb/i$j;->b:Ljb/i$d;
    ...
    :cond_1
    invoke-virtual {v2, v4}, Landroidx/core/view/k0;->b(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {v2, v6}, Landroidx/core/view/k0;->b(Z)V

    :cond_3
    :goto_0
    iget-object v3, p1, Ljb/i$j;->a:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v3, p1, Ljb/i$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Ljb/i$j;->e:Ljb/i$d;
    ...
    :cond_6
    invoke-virtual {v2, v4}, Landroidx/core/view/k0;->a(Z)V

    goto :goto_1

    :cond_7
    invoke-virtual {v2, v6}, Landroidx/core/view/k0;->a(Z)V

    :cond_8
    :goto_1
    iget-object v2, p1, Ljb/i$j;->d:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Ljb/i$j;->f:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v2, p1, Ljb/i$j;->g:Ljava/lang/Boolean;
    ...
    :cond_b
    iput-object p1, p0, Lio/flutter/plugin/platform/c;->d:Ljb/i$j;
...
.method public A()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/c;->d:Ljb/i$j;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/c;->z(Ljb/i$j;)V
...
.method public o()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/c;->b:Ljb/i;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ljb/i;->l(Ljb/i$h;)V
