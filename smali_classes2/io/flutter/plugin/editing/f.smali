...
.field private n:Ljb/p$e;

.field private o:Z


# direct methods
.method public constructor <init>(Landroid/view/View;Ljb/p;Lio/flutter/plugin/platform/q;)V
    .locals 4
    ...
    invoke-direct {v0, v1, p1}, Lio/flutter/plugin/editing/c;-><init>(Ljb/p$e;Landroid/view/View;)V
    ...
    :cond_3
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->d:Ljb/p;
    ...
    invoke-virtual {p2, p1}, Ljb/p;->n(Ljb/p$f;)V

    invoke-virtual {p2}, Ljb/p;->k()V
...
.method private C(IZ)V
    ...
    sget-object v0, Lio/flutter/plugin/editing/f$c$a;->q:Lio/flutter/plugin/editing/f$c$a;
    ...
    sget-object v0, Lio/flutter/plugin/editing/f$c$a;->r:Lio/flutter/plugin/editing/f$c$a;
...
.method private H(Ljb/p$b;)V
    ...
    iget-object v0, p1, Ljb/p$b;->j:Ljb/p$b$a;
    ...
    :cond_1
    iget-object v0, p1, Ljb/p$b;->l:[Ljb/p$b;
    ...
    iget-object v0, v0, Ljb/p$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v2, Ljb/p$b;->j:Ljb/p$b$a;

    if-eqz v3, :cond_3

    iget-object v4, p0, Lio/flutter/plugin/editing/f;->g:Landroid/util/SparseArray;

    iget-object v5, v3, Ljb/p$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v3, Ljb/p$b$a;->c:Ljb/p$e;

    iget-object v3, v3, Ljb/p$e;->a:Ljava/lang/String;
...
.method private k()Z
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->f:Ljb/p$b;

    const/4 v1, 0x1

    if-eqz v0, :cond_2

    iget-object v0, v0, Ljb/p$b;->g:Ljb/p$c;
    ...
    :cond_0
    iget-object v0, v0, Ljb/p$c;->a:Ljb/p$g;

    sget-object v2, Ljb/p$g;->z:Ljb/p$g;
...
.method private static n(Ljb/p$e;Ljb/p$e;)Z
    .locals 7

    iget v0, p0, Ljb/p$e;->e:I

    iget v1, p0, Ljb/p$e;->d:I

    sub-int/2addr v0, v1

    iget v1, p1, Ljb/p$e;->e:I

    iget v2, p1, Ljb/p$e;->d:I
    ...
    iget-object v4, p0, Ljb/p$e;->a:Ljava/lang/String;

    iget v5, p0, Ljb/p$e;->d:I
    ...
    iget-object v5, p1, Ljb/p$e;->a:Ljava/lang/String;

    iget v6, p1, Ljb/p$e;->d:I
...
.method private static t(Ljb/p$c;ZZZZLjb/p$d;)I
    .locals 1

    iget-object p4, p0, Ljb/p$c;->a:Ljb/p$g;

    sget-object v0, Ljb/p$g;->q:Ljb/p$g;
    ...
    :cond_0
    sget-object v0, Ljb/p$g;->t:Ljb/p$g;

    if-ne p4, v0, :cond_3

    const/4 p1, 0x2

    iget-boolean p2, p0, Ljb/p$c;->b:Z
    ...
    :cond_1
    iget-boolean p0, p0, Ljb/p$c;->c:Z
    ...
    :cond_3
    sget-object p0, Ljb/p$g;->u:Ljb/p$g;
    ...
    :cond_4
    sget-object p0, Ljb/p$g;->z:Ljb/p$g;
    ...
    sget-object v0, Ljb/p$g;->v:Ljb/p$g;
    ...
    :cond_6
    sget-object v0, Ljb/p$g;->w:Ljb/p$g;
    ...
    :cond_7
    sget-object v0, Ljb/p$g;->x:Ljb/p$g;
    ...
    :cond_8
    sget-object v0, Ljb/p$g;->y:Ljb/p$g;
    ...
    :cond_9
    sget-object v0, Ljb/p$g;->r:Ljb/p$g;
    ...
    :cond_a
    sget-object v0, Ljb/p$g;->s:Ljb/p$g;
    ...
    :cond_e
    :goto_1
    sget-object p1, Ljb/p$d;->p:Ljb/p$d;
    ...
    :cond_f
    sget-object p1, Ljb/p$d;->q:Ljb/p$d;
    ...
    :cond_10
    sget-object p1, Ljb/p$d;->r:Ljb/p$d;
...
.method private w(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Ljb/p$b;->j:Ljb/p$b$a;
...
.method D(ILjb/p$b;)V
    ...
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->f:Ljb/p$b;
    ...
    sget-object v1, Lio/flutter/plugin/editing/f$c$a;->p:Lio/flutter/plugin/editing/f$c$a;
    ...
    iget-object v0, p2, Ljb/p$b;->j:Ljb/p$b$a;

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    iget-object v0, v0, Ljb/p$b$a;->c:Ljb/p$e;
    ...
    invoke-direct {p1, v0, v2}, Lio/flutter/plugin/editing/c;-><init>(Ljb/p$e;Landroid/view/View;)V

    iput-object p1, p0, Lio/flutter/plugin/editing/f;->h:Lio/flutter/plugin/editing/c;

    invoke-direct {p0, p2}, Lio/flutter/plugin/editing/f;->H(Ljb/p$b;)V
...
.method E(Landroid/view/View;Ljb/p$e;)V
    .locals 2
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->n:Ljb/p$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ljb/p$e;->b()Z
    ...
    invoke-static {v0, p2}, Lio/flutter/plugin/editing/f;->n(Ljb/p$e;Ljb/p$e;)Z
    ...
    invoke-static {v0, v1}, Lxa/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iput-object p2, p0, Lio/flutter/plugin/editing/f;->n:Ljb/p$e;

    iget-object v0, p0, Lio/flutter/plugin/editing/f;->h:Lio/flutter/plugin/editing/c;

    invoke-virtual {v0, p2}, Lio/flutter/plugin/editing/c;->n(Ljb/p$e;)V
...
.method public G()V
    ...
    sget-object v1, Lio/flutter/plugin/editing/f$c$a;->q:Lio/flutter/plugin/editing/f$c$a;
...
.method public a(ZZZ)V
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/f;->n:Ljb/p$e;
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/f;->n:Ljb/p$e;

    iget-object v2, v2, Ljb/p$e;->a:Ljava/lang/String;
    ...
    iget v2, v1, Ljb/p$e;->b:I

    if-ne p1, v2, :cond_1

    iget v2, v1, Ljb/p$e;->c:I

    if-ne p2, v2, :cond_1

    iget v2, v1, Ljb/p$e;->d:I

    if-ne p3, v2, :cond_1

    iget v1, v1, Ljb/p$e;->e:I
    ...
    invoke-static {v2, v1}, Lxa/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lio/flutter/plugin/editing/f;->f:Ljb/p$b;

    iget-boolean v1, v1, Ljb/p$b;->e:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, Lio/flutter/plugin/editing/f;->d:Ljb/p;
    ...
    invoke-virtual {v1, v2, v0}, Ljb/p;->q(ILjava/util/ArrayList;)V
    ...
    :cond_3
    iget-object v0, p0, Lio/flutter/plugin/editing/f;->d:Ljb/p;
    ...
    invoke-virtual/range {v0 .. v6}, Ljb/p;->p(ILjava/lang/String;IIII)V

    :goto_2
    new-instance v6, Ljb/p$e;
    ...
    invoke-direct/range {v0 .. v5}, Ljb/p$e;-><init>(Ljava/lang/String;IIII)V

    iput-object v6, p0, Lio/flutter/plugin/editing/f;->n:Ljb/p$e;
...
.method public j(Landroid/util/SparseArray;)V
    ...
    check-cast v3, Ljb/p$b;

    if-eqz v3, :cond_4

    iget-object v3, v3, Ljb/p$b;->j:Ljb/p$b$a;
    ...
    invoke-direct/range {v5 .. v10}, Ljb/p$e;-><init>(Ljava/lang/String;IIII)V

    iget-object v5, v3, Ljb/p$b$a;->a:Ljava/lang/String;

    iget-object v6, v0, Ljb/p$b$a;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lio/flutter/plugin/editing/c;->n(Ljb/p$e;)V

    goto :goto_1

    :cond_3
    iget-object v3, v3, Ljb/p$b$a;->a:Ljava/lang/String;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/plugin/editing/f;->d:Ljb/p;

    iget-object v0, p0, Lio/flutter/plugin/editing/f;->e:Lio/flutter/plugin/editing/f$c;

    iget v0, v0, Lio/flutter/plugin/editing/f$c;->b:I

    invoke-virtual {p1, v0, v1}, Ljb/p;->r(ILjava/util/HashMap;)V
...
.method public l(I)V
    ...
    sget-object v2, Lio/flutter/plugin/editing/f$c$a;->q:Lio/flutter/plugin/editing/f$c$a;

    if-eq v1, v2, :cond_0

    sget-object v2, Lio/flutter/plugin/editing/f$c$a;->r:Lio/flutter/plugin/editing/f$c$a;
    ...
    sget-object v0, Lio/flutter/plugin/editing/f$c$a;->o:Lio/flutter/plugin/editing/f$c$a;
...
.method m()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/f;->f:Ljb/p$b;

    invoke-direct {p0, v0}, Lio/flutter/plugin/editing/f;->H(Ljb/p$b;)V

    new-instance v1, Lio/flutter/plugin/editing/f$c;

    sget-object v2, Lio/flutter/plugin/editing/f$c$a;->o:Lio/flutter/plugin/editing/f$c$a;
...
.method public o(Landroid/view/View;Lio/flutter/embedding/android/s;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    invoke-virtual {p1, p2}, Lio/flutter/plugin/platform/q;->b(I)Landroid/view/View;
    ...
    iget-object v1, v0, Ljb/p$b;->g:Ljb/p$c;

    iget-boolean v2, v0, Ljb/p$b;->a:Z

    iget-boolean v3, v0, Ljb/p$b;->b:Z

    iget-boolean v4, v0, Ljb/p$b;->c:Z

    iget-boolean v5, v0, Ljb/p$b;->d:Z

    iget-object v6, v0, Ljb/p$b;->f:Ljb/p$d;

    invoke-static/range {v1 .. v6}, Lio/flutter/plugin/editing/f;->t(Ljb/p$c;ZZZZLjb/p$d;)I
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/f;->f:Ljb/p$b;

    iget-boolean v2, v2, Ljb/p$b;->d:Z
    ...
    iget-object v1, v1, Ljb/p$b;->h:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Ljb/p$b;->i:Ljava/lang/String;
    ...
    iget-object v0, v1, Ljb/p$b;->k:[Ljava/lang/String;

    if-eqz v0, :cond_8

    invoke-static {p3, v0}, La0/a;->d(Landroid/view/inputmethod/EditorInfo;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lio/flutter/plugin/editing/f;->d:Ljb/p;
    ...
    invoke-direct/range {v1 .. v7}, Lio/flutter/plugin/editing/b;-><init>(Landroid/view/View;ILjb/p;Lio/flutter/plugin/editing/b$a;Lio/flutter/plugin/editing/c;Landroid/view/inputmethod/EditorInfo;)V
...
.method public p()V
    ...
    invoke-virtual {v0, v1}, Ljb/p;->n(Ljb/p$f;)V
...
.method public z(Landroid/view/ViewStructure;I)V
    ...
    :cond_0
    iget-object v2, v0, Lio/flutter/plugin/editing/f;->f:Ljb/p$b;

    iget-object v2, v2, Ljb/p$b;->j:Ljb/p$b$a;

    iget-object v2, v2, Ljb/p$b$a;->a:Ljava/lang/String;
    ...
    check-cast v7, Ljb/p$b;

    iget-object v7, v7, Ljb/p$b;->j:Ljb/p$b$a;
    ...
    iget-object v9, v7, Ljb/p$b$a;->b:[Ljava/lang/String;
    ...
    iget-object v8, v7, Ljb/p$b$a;->d:Ljava/lang/String;
    ...
    iget-object v6, v7, Ljb/p$b$a;->c:Ljb/p$e;

    iget-object v6, v6, Ljb/p$e;->a:Ljava/lang/String;
