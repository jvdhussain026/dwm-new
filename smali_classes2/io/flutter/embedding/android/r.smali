...
.method public constructor <init>(Lkb/c;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/r;->a:Lkb/c;
...
.method public static synthetic b(Lio/flutter/embedding/android/r;Lio/flutter/embedding/android/t$c;Landroid/view/KeyEvent;)V
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/embedding/android/r;->l(Lio/flutter/embedding/android/t$c;Landroid/view/KeyEvent;)V
...
.method public static synthetic c(Lio/flutter/embedding/android/s$d$a;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p1}, Lio/flutter/embedding/android/r;->j(Lio/flutter/embedding/android/s$d$a;Ljava/nio/ByteBuffer;)V
...
.method public static synthetic d(Lio/flutter/embedding/android/r;Lio/flutter/embedding/android/t$c;JLandroid/view/KeyEvent;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lio/flutter/embedding/android/r;->k(Lio/flutter/embedding/android/t$c;JLandroid/view/KeyEvent;)V
...
.method private static e(Landroid/view/KeyEvent;)Lio/flutter/embedding/android/n$a;
    ...
    sget-object p0, Lio/flutter/embedding/android/n$a;->q:Lio/flutter/embedding/android/n$a;
    ...
    sget-object p0, Lio/flutter/embedding/android/n$a;->r:Lio/flutter/embedding/android/n$a;

    goto :goto_1

    :cond_3
    sget-object p0, Lio/flutter/embedding/android/n$a;->p:Lio/flutter/embedding/android/n$a;
...
.method private f(Landroid/view/KeyEvent;)Ljava/lang/Long;
    ...
    invoke-static {v0, v1, v2, v3}, Lio/flutter/embedding/android/r;->i(JJ)J
...
.method private h(Landroid/view/KeyEvent;Lio/flutter/embedding/android/s$d$a;)Z
    .locals 17
    ...
    invoke-virtual/range {v0 .. v8}, Lio/flutter/embedding/android/r;->n(Lio/flutter/embedding/android/t$d;ZJJLandroid/view/KeyEvent;Ljava/util/ArrayList;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/embedding/android/r;->o(Lio/flutter/embedding/android/t$e;ZJLandroid/view/KeyEvent;)V
    ...
    :goto_5
    sget-object v0, Lio/flutter/embedding/android/n$a;->p:Lio/flutter/embedding/android/n$a;
    ...
    invoke-direct/range {v0 .. v5}, Lio/flutter/embedding/android/r;->p(ZLjava/lang/Long;Ljava/lang/Long;J)V
    ...
    :cond_a
    sget-object v0, Lio/flutter/embedding/android/n$a;->q:Lio/flutter/embedding/android/n$a;

    :cond_b
    move-object v1, v8

    :goto_7
    sget-object v2, Lio/flutter/embedding/android/n$a;->r:Lio/flutter/embedding/android/n$a;
    ...
    :cond_c
    invoke-virtual {v9, v11, v8}, Lio/flutter/embedding/android/r;->q(Ljava/lang/Long;Ljava/lang/Long;)V

    :cond_d
    sget-object v2, Lio/flutter/embedding/android/n$a;->p:Lio/flutter/embedding/android/n$a;
    ...
    invoke-direct {v9, v2, v0}, Lio/flutter/embedding/android/r;->m(Lio/flutter/embedding/android/n;Lio/flutter/embedding/android/s$d$a;)V
...
.method private static synthetic j(Lio/flutter/embedding/android/s$d$a;Ljava/nio/ByteBuffer;)V
    .locals 2
...
.method private synthetic k(Lio/flutter/embedding/android/t$c;JLandroid/view/KeyEvent;)V
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lio/flutter/embedding/android/r;->p(ZLjava/lang/Long;Ljava/lang/Long;J)V

    return-void
.end method

.method private synthetic l(Lio/flutter/embedding/android/t$c;Landroid/view/KeyEvent;)V
    .locals 8
...
.method private m(Lio/flutter/embedding/android/n;Lio/flutter/embedding/android/s$d$a;)V
    .locals 2
    ...
    :goto_0
    iget-object v0, p0, Lio/flutter/embedding/android/r;->a:Lkb/c;
...
.method private p(ZLjava/lang/Long;Ljava/lang/Long;J)V
    .locals 5
    ...
    sget-object p4, Lio/flutter/embedding/android/n$a;->p:Lio/flutter/embedding/android/n$a;

    goto :goto_0

    :cond_0
    sget-object p4, Lio/flutter/embedding/android/n$a;->q:Lio/flutter/embedding/android/n$a;
    ...
    :goto_1
    invoke-virtual {p0, p3, p2}, Lio/flutter/embedding/android/r;->q(Ljava/lang/Long;Ljava/lang/Long;)V

    :cond_2
    invoke-direct {p0, v0, p4}, Lio/flutter/embedding/android/r;->m(Lio/flutter/embedding/android/n;Lio/flutter/embedding/android/s$d$a;)V
...
.method public a(Landroid/view/KeyEvent;Lio/flutter/embedding/android/s$d$a;)V
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/embedding/android/r;->h(Landroid/view/KeyEvent;Lio/flutter/embedding/android/s$d$a;)Z
...
.method n(Lio/flutter/embedding/android/t$d;ZJJLandroid/view/KeyEvent;Ljava/util/ArrayList;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method o(Lio/flutter/embedding/android/t$e;ZJLandroid/view/KeyEvent;)V
    .locals 6
...
.method q(Ljava/lang/Long;Ljava/lang/Long;)V
    .locals 1
