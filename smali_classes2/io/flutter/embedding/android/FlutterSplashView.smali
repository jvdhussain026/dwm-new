...
# static fields
.field private static x:Ljava/lang/String; = "FlutterSplashView"


# instance fields
.field private o:Lio/flutter/embedding/android/x;

.field private p:Lio/flutter/embedding/android/k;
...
.field private final u:Lio/flutter/embedding/android/k$f;

.field private final v:Lib/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->u:Lio/flutter/embedding/android/k$f;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->v:Lib/b;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->w:Ljava/lang/Runnable;
...
.method static synthetic a(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/k;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->p:Lio/flutter/embedding/android/k;
...
.method static synthetic b(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/x;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->o:Lio/flutter/embedding/android/x;
...
.method static synthetic d(Lio/flutter/embedding/android/FlutterSplashView;)Landroid/view/View;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->q:Landroid/view/View;
...
.method static synthetic e(Lio/flutter/embedding/android/FlutterSplashView;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->t:Ljava/lang/String;
...
.method static synthetic f(Lio/flutter/embedding/android/FlutterSplashView;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->s:Ljava/lang/String;
...
.method private h()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->p:Lio/flutter/embedding/android/k;
    ...
    invoke-virtual {v0}, Lya/a;->m()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->t:Ljava/lang/String;
...
.method private j()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->o:Lio/flutter/embedding/android/x;
...
.method private k()V
    ...
    sget-object v0, Lio/flutter/embedding/android/FlutterSplashView;->x:Ljava/lang/String;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/FlutterSplashView;->s:Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->w:Ljava/lang/Runnable;
...
.method public g(Lio/flutter/embedding/android/k;Lio/flutter/embedding/android/x;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->v:Lib/b;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->q:Landroid/view/View;
    ...
    :cond_1
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->p:Lio/flutter/embedding/android/k;

    invoke-virtual {p0, p1}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    iput-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->o:Lio/flutter/embedding/android/x;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->r:Landroid/os/Bundle;
    ...
    iput-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->q:Landroid/view/View;

    invoke-virtual {p0, p2}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->v:Lib/b;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/k;->m(Lib/b;)V
    ...
    sget-object p1, Lio/flutter/embedding/android/FlutterSplashView;->x:Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->r:Landroid/os/Bundle;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->q:Landroid/view/View;
    ...
    sget-object p2, Lio/flutter/embedding/android/FlutterSplashView;->x:Ljava/lang/String;

    const-string v0, "FlutterView is not yet attached to a FlutterEngine. Showing nothing until a FlutterEngine is attached."

    invoke-static {p2, v0}, Lxa/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->u:Lio/flutter/embedding/android/k$f;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->t:Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->r:Landroid/os/Bundle;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->t:Ljava/lang/String;
