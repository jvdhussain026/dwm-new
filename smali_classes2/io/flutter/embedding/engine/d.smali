...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lab/f;->q(Landroid/content/Context;)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Lab/f;->g(Landroid/content/Context;[Ljava/lang/String;)V
...
.method public a(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->c()Lya/a$c;
    ...
    invoke-static {}, Lya/a$c;->a()Lya/a$c;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->m()Ljb/h;

    move-result-object v0

    invoke-virtual {v0, v3}, Ljb/h;->c(Ljava/lang/String;)V

    :cond_2
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->i()Lya/a;

    move-result-object v0

    invoke-virtual {v0, v2, v4}, Lya/a;->k(Lya/a$c;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lio/flutter/embedding/engine/a;->x(Landroid/content/Context;Lya/a$c;Ljava/lang/String;Ljava/util/List;Lio/flutter/plugin/platform/q;ZZ)Lio/flutter/embedding/engine/a;
