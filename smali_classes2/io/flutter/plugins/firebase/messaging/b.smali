...
.field private q:Lio/flutter/embedding/engine/a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugins/firebase/messaging/b;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-void
.end method

.method public static synthetic a(Lio/flutter/plugins/firebase/messaging/b;Lab/f;Landroid/os/Handler;Lio/flutter/embedding/engine/g;J)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lio/flutter/plugins/firebase/messaging/b;->k(Lab/f;Landroid/os/Handler;Lio/flutter/embedding/engine/g;J)V

    return-void
.end method

.method public static synthetic b(Lio/flutter/plugins/firebase/messaging/b;Lab/f;Lio/flutter/embedding/engine/g;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lio/flutter/plugins/firebase/messaging/b;->j(Lab/f;Lio/flutter/embedding/engine/g;J)V
...
.method private g(Lkb/c;)V
    ...
    iput-object v0, p0, Lio/flutter/plugins/firebase/messaging/b;->p:Lkb/k;
...
.method private synthetic j(Lab/f;Lio/flutter/embedding/engine/g;J)V
    .locals 4

    invoke-virtual {p1}, Lab/f;->i()Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/flutter/plugins/firebase/messaging/b;->q:Lio/flutter/embedding/engine/a;
    ...
    iput-object p2, p0, Lio/flutter/plugins/firebase/messaging/b;->q:Lio/flutter/embedding/engine/a;
    ...
    iget-object p3, p0, Lio/flutter/plugins/firebase/messaging/b;->q:Lio/flutter/embedding/engine/a;

    invoke-virtual {p3}, Lio/flutter/embedding/engine/a;->i()Lya/a;

    move-result-object p3

    invoke-direct {p0, p3}, Lio/flutter/plugins/firebase/messaging/b;->g(Lkb/c;)V

    new-instance p4, Lya/a$b;

    invoke-direct {p4, v0, p1, p2}, Lya/a$b;-><init>(Landroid/content/res/AssetManager;Ljava/lang/String;Lio/flutter/view/FlutterCallbackInformation;)V

    invoke-virtual {p3, p4}, Lya/a;->j(Lya/a$b;)V

    :cond_1
    return-void
.end method

.method private synthetic k(Lab/f;Landroid/os/Handler;Lio/flutter/embedding/engine/g;J)V
    .locals 8
    ...
    invoke-virtual {p1, v0}, Lab/f;->q(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v6}, Lqb/c;-><init>(Lio/flutter/plugins/firebase/messaging/b;Lab/f;Lio/flutter/embedding/engine/g;J)V

    const/4 p3, 0x0

    invoke-virtual {p1, v0, p3, p2, v7}, Lab/f;->h(Landroid/content/Context;[Ljava/lang/String;Landroid/os/Handler;Ljava/lang/Runnable;)V
...
.method private l()V
    ...
    iget-object v0, p0, Lio/flutter/plugins/firebase/messaging/b;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public d(Landroid/content/Intent;Ljava/util/concurrent/CountDownLatch;)V
    ...
    iget-object v0, p0, Lio/flutter/plugins/firebase/messaging/b;->q:Lio/flutter/embedding/engine/a;
    ...
    iget-object p2, p0, Lio/flutter/plugins/firebase/messaging/b;->p:Lkb/k;
    ...
    invoke-virtual {p2, p1, v1, v0}, Lkb/k;->d(Ljava/lang/String;Ljava/lang/Object;Lkb/k$d;)V
...
.method public p(JLio/flutter/embedding/engine/g;)V
    ...
    invoke-direct/range {v0 .. v6}, Lqb/b;-><init>(Lio/flutter/plugins/firebase/messaging/b;Lab/f;Landroid/os/Handler;Lio/flutter/embedding/engine/g;J)V
