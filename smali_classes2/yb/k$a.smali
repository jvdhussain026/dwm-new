...
# static fields
.field private static final e:Lzb/g;
...
.field private static final f:Lzb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzb/g<",
            "Ljava/net/Socket;",
...
.field private static final g:Lzb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzb/g<",
            "Ljava/net/Socket;",
...
.field private static final h:Lzb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzb/g<",
            "Ljava/net/Socket;",
...
.field private static final i:Lzb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzb/g<",
            "Ljava/net/Socket;",
...
.field private static final j:Lzb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzb/g<",
            "Ljava/net/Socket;",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v4, v9, v10, v6}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lyb/k$a;->e:Lzb/g;
    ...
    invoke-direct {v4, v9, v11, v6}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lyb/k$a;->f:Lzb/g;
    ...
    invoke-direct {v4, v3, v11, v6}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lyb/k$a;->g:Lzb/g;
    ...
    sput-object v4, Lyb/k$a;->h:Lzb/g;
    ...
    sput-object v4, Lyb/k$a;->i:Lzb/g;
    ...
    invoke-direct {v4, v9, v3, v6}, Lzb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lyb/k$a;->j:Lzb/g;
    ...
    :goto_2
    invoke-static {}, Lyb/k;->a()Ljava/util/logging/Logger;
    ...
    :goto_3
    sput-object v4, Lyb/k$a;->m:Ljava/lang/reflect/Method;

    sput-object v3, Lyb/k$a;->n:Ljava/lang/reflect/Method;

    sput-object v6, Lyb/k$a;->o:Ljava/lang/reflect/Method;

    sput-object v12, Lyb/k$a;->k:Ljava/lang/reflect/Method;

    sput-object v1, Lyb/k$a;->l:Ljava/lang/reflect/Method;
    ...
    :goto_6
    sput-object v1, Lyb/k$a;->p:Ljava/lang/reflect/Method;

    sput-object v9, Lyb/k$a;->q:Ljava/lang/reflect/Constructor;
...
.method constructor <init>(Lzb/h;)V
    ...
    invoke-direct {p0, p1}, Lyb/k;-><init>(Lzb/h;)V
...
.method protected c(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {p3}, Lyb/k;->b(Ljava/util/List;)[Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p2}, Lyb/k;->g(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_2

    sget-object v4, Lyb/k$a;->k:Ljava/lang/reflect/Method;
    ...
    sget-object v4, Lyb/k$a;->l:Ljava/lang/reflect/Method;
    ...
    :cond_0
    sget-object v4, Lyb/k$a;->e:Lzb/g;
    ...
    invoke-virtual {v4, p1, v5}, Lzb/g;->e(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;

    :goto_0
    sget-object v4, Lyb/k$a;->p:Ljava/lang/reflect/Method;

    if-eqz v4, :cond_1

    sget-object v5, Lyb/k$a;->q:Ljava/lang/reflect/Constructor;
    ...
    :cond_1
    sget-object v4, Lyb/k$a;->f:Lzb/g;
    ...
    :cond_2
    :goto_1
    sget-object p2, Lyb/k$a;->o:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sget-object p2, Lyb/k$a;->m:Ljava/lang/reflect/Method;
    ...
    sget-object p2, Lyb/k$a;->n:Ljava/lang/reflect/Method;
    ...
    iget-object p3, p0, Lyb/k;->a:Lzb/h;

    invoke-virtual {p3}, Lzb/h;->i()Lzb/h$h;

    move-result-object p3

    sget-object v0, Lzb/h$h;->o:Lzb/h$h;

    if-ne p3, v0, :cond_6

    sget-object p3, Lyb/k$a;->h:Lzb/g;
    ...
    sget-object v0, Lzb/h$h;->q:Lzb/h$h;

    if-eq p3, v0, :cond_7

    sget-object p3, Lyb/k$a;->j:Lzb/g;
...
.method public f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    sget-object v0, Lyb/k$a;->o:Ljava/lang/reflect/Method;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lyb/k;->a:Lzb/h;

    invoke-virtual {v0}, Lzb/h;->i()Lzb/h$h;

    move-result-object v0

    sget-object v2, Lzb/h$h;->o:Lzb/h$h;

    if-ne v0, v2, :cond_2

    :try_start_1
    sget-object v0, Lyb/k$a;->g:Lzb/g;
    ...
    sget-object v3, Lzb/l;->b:Ljava/nio/charset/Charset;
    ...
    sget-object v2, Lzb/h$h;->q:Lzb/h$h;

    if-eq v0, v2, :cond_3

    :try_start_2
    sget-object v0, Lyb/k$a;->i:Lzb/g;

    new-array v1, v1, [Ljava/lang/Object;

    invoke-virtual {v0, p1, v1}, Lzb/g;->f(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v1, Lzb/l;->b:Ljava/nio/charset/Charset;
...
.method public h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lyb/k$a;->f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2, p3}, Lyb/k;->h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
