...
.method public static g(Landroid/view/View;)Z
    ...
    invoke-static {p0}, Lb3/d;->c(Landroid/widget/TextView;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lb3/d;->a(Landroid/widget/TextView;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lb3/d;->d(Landroid/widget/TextView;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lb3/d;->f(Landroid/widget/TextView;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lb3/d;->e(Landroid/widget/TextView;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lb3/d;->b(Landroid/widget/TextView;)Z
