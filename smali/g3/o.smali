...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg3/o;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    sput-object v0, Lg3/o;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lg3/o;->c:Ljava/util/Map;
...
.method static synthetic a(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static {p0}, Lg3/o;->f(Ljava/lang/String;)Lorg/json/JSONObject;
...
.method static synthetic b(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 0

    invoke-static {p0, p1}, Lg3/o;->k(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method static synthetic c(Ljava/lang/Long;)Ljava/lang/Long;
    .locals 0

    sput-object p0, Lg3/o;->d:Ljava/lang/Long;
...
.method static synthetic e()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v0, Lg3/o;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static f(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, v2}, Lcom/facebook/h;->a0(Z)V
...
.method public static g(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {}, Lg3/o;->i()V

    if-eqz p1, :cond_1

    sget-object v0, Lg3/o;->c:Ljava/util/Map;
...
.method private static h(Ljava/lang/Long;)Z
    .locals 5
...
.method static declared-synchronized j(Lg3/o$c;)V
    .locals 8
    ...
    :try_start_0
    sget-object v1, Lg3/o;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p0}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    :cond_0
    sget-object p0, Lg3/o;->d:Ljava/lang/Long;

    invoke-static {p0}, Lg3/o;->h(Ljava/lang/Long;)Z
    ...
    invoke-static {v7, v4}, Lg3/a0;->R(Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_0
    if-eqz v6, :cond_3

    invoke-static {v1, v6}, Lg3/o;->k(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_4
    :try_start_5
    sget-object v6, Lg3/o;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_5
    :try_start_6
    new-instance v3, Lg3/o$a;

    invoke-direct {v3, v1, p0, v2}, Lg3/o$a;-><init>(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
...
.method private static declared-synchronized k(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    :try_start_0
    sget-object v1, Lg3/o;->c:Ljava/util/Map;
    ...
    invoke-static {v4, v2}, Lg3/a0;->R(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    :cond_2
    sget-object p1, Lg3/o;->c:Ljava/util/Map;
...
.method private static l()V
    ...
    check-cast v1, Lg3/o$c;

    if-eqz v1, :cond_0

    new-instance v2, Lg3/o$b;

    invoke-direct {v2, v1}, Lg3/o$b;-><init>(Lg3/o$c;)V
...
.method static m(Ljava/lang/String;Z)Lorg/json/JSONObject;
    .locals 4
