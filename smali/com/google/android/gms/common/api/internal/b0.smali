...
.field protected final s:Lc5/e;


# direct methods
.method constructor <init>(Le5/e;Lc5/e;)V
    .locals 1

    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/LifecycleCallback;-><init>(Le5/e;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/b0;->q:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p1, v0}, Lq5/f;-><init>(Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/b0;->r:Landroid/os/Handler;

    iput-object p2, p0, Lcom/google/android/gms/common/api/internal/b0;->s:Lc5/e;

    return-void
.end method

.method private final l(Lc5/b;I)V
    .locals 2

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/b0;->q:Ljava/util/concurrent/atomic/AtomicReference;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/common/api/internal/b0;->m(Lc5/b;I)V
...
.method static bridge synthetic q(Lcom/google/android/gms/common/api/internal/b0;Lc5/b;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/common/api/internal/b0;->l(Lc5/b;I)V
...
.method public final e(IILandroid/content/Intent;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/b0;->s:Lc5/e;

    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/LifecycleCallback;->b()Landroid/app/Activity;

    move-result-object p2

    invoke-virtual {p1, p2}, Lc5/e;->g(Landroid/content/Context;)I
    ...
    invoke-virtual {v1}, Lc5/b;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p2, p1, p3, v1}, Lc5/b;-><init>(ILandroid/app/PendingIntent;Ljava/lang/String;)V

    invoke-static {v0}, Lcom/google/android/gms/common/api/internal/b0;->p(Lcom/google/android/gms/common/api/internal/y;)I

    move-result p1

    invoke-direct {p0, p2, p1}, Lcom/google/android/gms/common/api/internal/b0;->l(Lc5/b;I)V
...
.method public final f(Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, v2, v3}, Lc5/b;-><init>(ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {v2, v1, p1}, Lcom/google/android/gms/common/api/internal/y;-><init>(Lc5/b;I)V
...
.method protected abstract m(Lc5/b;I)V
.end method
...
.method public final onCancel(Landroid/content/DialogInterface;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/gms/common/api/internal/b0;->l(Lc5/b;I)V

    return-void
.end method

.method public final s(Lc5/b;I)V
    .locals 1

    new-instance v0, Lcom/google/android/gms/common/api/internal/y;

    invoke-direct {v0, p1, p2}, Lcom/google/android/gms/common/api/internal/y;-><init>(Lc5/b;I)V

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/b0;->q:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/b0;->r:Landroid/os/Handler;
