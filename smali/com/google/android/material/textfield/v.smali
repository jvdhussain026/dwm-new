...
# instance fields
.field private final s:Landroidx/appcompat/widget/l0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, p3, v0}, Lz6/a;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/v;->u:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Ld6/k;->U1:[I
    ...
    iput p3, p0, Lcom/google/android/material/textfield/v;->w:F
    ...
    iput p3, p0, Lcom/google/android/material/textfield/v;->x:I
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/v;->t:Landroid/view/accessibility/AccessibilityManager;

    new-instance p3, Landroidx/appcompat/widget/l0;

    invoke-direct {p3, p1}, Landroidx/appcompat/widget/l0;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/google/android/material/textfield/v;->s:Landroidx/appcompat/widget/l0;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/l0;->J(Z)V

    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/l0;->D(Landroid/view/View;)V

    const/4 p1, 0x2

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/l0;->I(I)V

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/l0;->p(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/l0;->L(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic b(Lcom/google/android/material/textfield/v;)Landroidx/appcompat/widget/l0;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/textfield/v;->s:Landroidx/appcompat/widget/l0;
...
.method static synthetic d(Lcom/google/android/material/textfield/v;)I
    ...
    iget p0, p0, Lcom/google/android/material/textfield/v;->x:I
...
.method static synthetic e(Lcom/google/android/material/textfield/v;)Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/v;->y:Landroid/content/res/ColorStateList;
...
.method private g()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->t:Landroid/view/accessibility/AccessibilityManager;
...
.method private h()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/v;->s:Landroidx/appcompat/widget/l0;

    invoke-virtual {v5}, Landroidx/appcompat/widget/l0;->x()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->s:Landroidx/appcompat/widget/l0;

    invoke-virtual {v0}, Landroidx/appcompat/widget/l0;->i()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v2, p0, Lcom/google/android/material/textfield/v;->u:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lcom/google/android/material/textfield/v;->u:Landroid/graphics/Rect;
...
.method public getPopupElevation()F
    ...
    iget v0, p0, Lcom/google/android/material/textfield/v;->w:F
...
.method public getSimpleItemSelectedColor()I
    ...
    iget v0, p0, Lcom/google/android/material/textfield/v;->x:I
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/v;->s:Landroidx/appcompat/widget/l0;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/l0;->p(Landroid/widget/ListAdapter;)V
...
.method public setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/l0;->c(Landroid/graphics/drawable/Drawable;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/l0;->M(Landroid/widget/AdapterView$OnItemSelectedListener;)V
...
.method public setSimpleItemSelectedColor(I)V
    ...
    iput p1, p0, Lcom/google/android/material/textfield/v;->x:I
...
.method public setSimpleItems([Ljava/lang/String;)V
    ...
    iget v2, p0, Lcom/google/android/material/textfield/v;->v:I
