...
.method constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/y0;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/z;->o:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/z;->r:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/z;->p:Landroid/widget/TextView;

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/z;->i(Landroidx/appcompat/widget/y0;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/z;->h(Landroidx/appcompat/widget/y0;)V
...
.method private B()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/z;->q:Ljava/lang/CharSequence;
    ...
    iget-boolean v0, p0, Lcom/google/android/material/textfield/z;->x:Z
    ...
    :goto_0
    iget-object v3, p0, Lcom/google/android/material/textfield/z;->r:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/z;->p:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setVisibility(I)V

    iget-object v0, p0, Lcom/google/android/material/textfield/z;->o:Lcom/google/android/material/textfield/TextInputLayout;
...
.method private h(Landroidx/appcompat/widget/y0;)V
    .locals 3

    iget-object v0, p0, Lcom/google/android/material/textfield/z;->p:Landroid/widget/TextView;
...
.method private i(Landroidx/appcompat/widget/y0;)V
    .locals 4
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/z;->r:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {v2, p1, v1}, Ls6/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/y0;I)Landroid/content/res/ColorStateList;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/material/textfield/z;->s:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, v0}, Lcom/google/android/material/internal/r;->f(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/textfield/z;->t:Landroid/graphics/PorterDuff$Mode;
...
.method A()V
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/material/textfield/z;->p:Landroid/widget/TextView;
    ...
    invoke-static {v2, v1, v3, v4, v0}, Landroidx/core/view/y;->G0(Landroid/view/View;IIII)V
...
.method f()I
    ...
    iget v0, p0, Lcom/google/android/material/textfield/z;->u:I
...
.method g()Landroid/widget/ImageView$ScaleType;
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/z;->v:Landroid/widget/ImageView$ScaleType;
...
.method k(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/android/material/textfield/z;->x:Z
...
.method l()V
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/z;->r:Lcom/google/android/material/internal/CheckableImageButton;

    iget-object v2, p0, Lcom/google/android/material/textfield/z;->s:Landroid/content/res/ColorStateList;
...
.method m(Ljava/lang/CharSequence;)V
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/material/textfield/z;->q:Ljava/lang/CharSequence;
...
.method r(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/z;->o:Lcom/google/android/material/textfield/TextInputLayout;

    iget-object v0, p0, Lcom/google/android/material/textfield/z;->r:Lcom/google/android/material/internal/CheckableImageButton;

    iget-object v1, p0, Lcom/google/android/material/textfield/z;->s:Landroid/content/res/ColorStateList;

    iget-object v2, p0, Lcom/google/android/material/textfield/z;->t:Landroid/graphics/PorterDuff$Mode;
...
.method s(I)V
    ...
    iput p1, p0, Lcom/google/android/material/textfield/z;->u:I
...
.method t(Landroid/view/View$OnClickListener;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/z;->w:Landroid/view/View$OnLongClickListener;
...
.method u(Landroid/view/View$OnLongClickListener;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/z;->w:Landroid/view/View$OnLongClickListener;
...
.method v(Landroid/widget/ImageView$ScaleType;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/z;->v:Landroid/widget/ImageView$ScaleType;
...
.method w(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/z;->s:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lcom/google/android/material/textfield/z;->s:Landroid/content/res/ColorStateList;
...
.method x(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/z;->t:Landroid/graphics/PorterDuff$Mode;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lcom/google/android/material/textfield/z;->t:Landroid/graphics/PorterDuff$Mode;
...
.method z(Landroidx/core/view/accessibility/d;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/core/view/accessibility/d;->i0(Landroid/view/View;)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Landroidx/core/view/accessibility/d;->u0(Landroid/view/View;)V
