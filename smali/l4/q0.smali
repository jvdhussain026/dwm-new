...
.method public final i()Ll4/w4;
    ...
    sget-object v1, Ll4/w4;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public final k()Ll4/m2;
    ...
    :cond_1
    new-instance v2, Ll4/k2;

    invoke-direct {v2, v1}, Ll4/k2;-><init>(Landroid/os/IBinder;)V
...
.method public final l()Ll4/p2;
    ...
    instance-of v3, v2, Ll4/p2;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Ll4/p2;

    goto :goto_0

    :cond_1
    new-instance v2, Ll4/n2;

    invoke-direct {v2, v1}, Ll4/n2;-><init>(Landroid/os/IBinder;)V
