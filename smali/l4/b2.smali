...
.method public static P5(Landroid/os/IBinder;)Ll4/c2;
    .locals 2
    ...
    instance-of v1, v0, Ll4/c2;

    if-eqz v1, :cond_1

    check-cast v0, Ll4/c2;

    return-object v0

    :cond_1
    new-instance v0, Ll4/a2;

    invoke-direct {v0, p0}, Ll4/a2;-><init>(Landroid/os/IBinder;)V
...
.method protected final O5(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0}, Ll4/c2;->d()V
