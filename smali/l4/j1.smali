...
.method public static asInterface(Landroid/os/IBinder;)Ll4/k1;
    .locals 2
    ...
    instance-of v1, v0, Ll4/k1;

    if-eqz v1, :cond_1

    check-cast v0, Ll4/k1;
    ...
    invoke-direct {v0, p0}, Ll4/i1;-><init>(Landroid/os/IBinder;)V
...
.method protected final O5(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_0
    invoke-interface {p0}, Ll4/k1;->getAdapterCreator()Lcom/google/android/gms/internal/ads/s30;
    ...
    :cond_1
    invoke-interface {p0}, Ll4/k1;->getLiteSdkVersion()Ll4/n3;
