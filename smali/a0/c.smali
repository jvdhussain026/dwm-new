...
.method public static synthetic a(Landroid/view/View;La0/d;ILandroid/os/Bundle;)Z
    ...
    invoke-static {p0, p1, p2, p3}, La0/c;->f(Landroid/view/View;La0/d;ILandroid/os/Bundle;)Z
...
.method private static b(Landroid/view/View;)La0/c$c;
    .locals 1
...
.method public static c(Landroid/view/View;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    invoke-static {p0}, La0/c;->b(Landroid/view/View;)La0/c$c;

    move-result-object p0

    invoke-static {p1, p2, p0}, La0/c;->d(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;La0/c$c;)Landroid/view/inputmethod/InputConnection;
...
.method public static d(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;La0/c$c;)Landroid/view/inputmethod/InputConnection;
    .locals 3
    ...
    invoke-direct {p1, p0, v1, p2}, La0/c$a;-><init>(Landroid/view/inputmethod/InputConnection;ZLa0/c$c;)V

    return-object p1

    :cond_0
    invoke-static {p1}, La0/a;->a(Landroid/view/inputmethod/EditorInfo;)[Ljava/lang/String;
    ...
    :cond_1
    new-instance p1, La0/c$b;

    invoke-direct {p1, p0, v1, p2}, La0/c$b;-><init>(Landroid/view/inputmethod/InputConnection;ZLa0/c$c;)V

    return-object p1
.end method

.method static e(Ljava/lang/String;Landroid/os/Bundle;La0/c$c;)Z
    .locals 7
    ...
    invoke-direct {p1, v3, v4, v5}, La0/d;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V

    invoke-interface {p2, p1, v6, p0}, La0/c$c;->a(La0/d;ILandroid/os/Bundle;)Z
...
.method private static synthetic f(Landroid/view/View;La0/d;ILandroid/os/Bundle;)Z
    .locals 5
    ...
    invoke-static {p0, p1}, Landroidx/core/view/y;->h0(Landroid/view/View;Landroidx/core/view/c;)Landroidx/core/view/c;
