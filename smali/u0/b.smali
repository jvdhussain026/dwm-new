...
.field private final t:Ljava/nio/channels/FileLock;
...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lu0/b;->o:Ljava/io/File;

    iput-object p2, p0, Lu0/b;->q:Ljava/io/File;

    invoke-static {p1}, Lu0/b;->y(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Lu0/b;->p:J
    ...
    iput-object p2, p0, Lu0/b;->r:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Lu0/b;->s:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Lu0/b;->t:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Lu0/b;->s:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Lu0/b;->d(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Lu0/b;->r:Ljava/io/RandomAccessFile;
...
.method private static H(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    .locals 7
    ...
    invoke-static {p1}, Lu0/b;->s(Ljava/io/File;)J
...
.method private M(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    ...
    iget-object v3, v0, Lu0/b;->o:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lu0/b;->l(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Lu0/b$b;

    iget-object v9, v0, Lu0/b;->q:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lu0/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lu0/b;->y(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lu0/b$b;->o:J
...
.method private N()Ljava/util/List;
    ...
    iget-object v6, v1, Lu0/b;->o:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Lu0/b;->a()V
    ...
    iget-object v0, v1, Lu0/b;->o:Ljava/io/File;
    ...
    new-instance v11, Lu0/b$b;

    iget-object v12, v1, Lu0/b;->q:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Lu0/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, Lu0/b;->e(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Lu0/b;->y(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Lu0/b$b;->o:J
    :try_end_1
...
.method private static S(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private a()V
    ...
    iget-object v0, p0, Lu0/b;->q:Ljava/io/File;

    new-instance v1, Lu0/b$a;

    invoke-direct {v1, p0}, Lu0/b$a;-><init>(Lu0/b;)V
    ...
    iget-object v2, p0, Lu0/b;->q:Ljava/io/File;
...
.method private static e(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lu0/b;->d(Ljava/io/Closeable;)V
...
.method private static y(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lu0/c;->c(Ljava/io/File;)J
...
# virtual methods
.method I(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lu0/b;->o:Ljava/io/File;
    ...
    iget-object v0, p0, Lu0/b;->t:Ljava/nio/channels/FileLock;
    ...
    iget-object v0, p0, Lu0/b;->o:Ljava/io/File;

    iget-wide v2, p0, Lu0/b;->p:J

    invoke-static {p1, v0, v2, v3, p2}, Lu0/b;->H(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lu0/b;->M(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Lu0/b;->N()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Lu0/b;->o:Ljava/io/File;

    invoke-static {v0}, Lu0/b;->s(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Lu0/b;->p:J
    ...
    invoke-static/range {v2 .. v8}, Lu0/b;->S(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public close()V
    ...
    iget-object v0, p0, Lu0/b;->s:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, Lu0/b;->r:Ljava/io/RandomAccessFile;
