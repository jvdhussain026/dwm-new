...
.method constructor <init>()V
    ...
    iput v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->g:F
    ...
    iput v1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->l:F

    iput v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->m:F

    sget-object v0, Landroid/graphics/Paint$Cap;->BUTT:Landroid/graphics/Paint$Cap;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->n:Landroid/graphics/Paint$Cap;

    sget-object v0, Landroid/graphics/Paint$Join;->MITER:Landroid/graphics/Paint$Join;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->o:Landroid/graphics/Paint$Join;

    const/high16 v0, 0x40800000    # 4.0f

    iput v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->p:F
...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/i$c;)V
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->e:[I

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->e:[I

    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->f:Landroidx/core/content/res/d;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->f:Landroidx/core/content/res/d;

    iget v0, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->g:F
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->h:Landroidx/core/content/res/d;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->h:Landroidx/core/content/res/d;
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->n:Landroid/graphics/Paint$Cap;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->n:Landroid/graphics/Paint$Cap;

    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->o:Landroid/graphics/Paint$Join;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->o:Landroid/graphics/Paint$Join;

    iget p1, p1, Landroidx/vectordrawable/graphics/drawable/i$c;->p:F

    iput p1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->p:F
...
.method private h(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$f;->a:[Landroidx/core/graphics/d$b;
    ...
    iget v1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->j:F
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->n:Landroid/graphics/Paint$Cap;

    invoke-direct {p0, v0, v1}, Landroidx/vectordrawable/graphics/drawable/i$c;->e(ILandroid/graphics/Paint$Cap;)Landroid/graphics/Paint$Cap;
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->o:Landroid/graphics/Paint$Join;

    invoke-direct {p0, v0, v1}, Landroidx/vectordrawable/graphics/drawable/i$c;->f(ILandroid/graphics/Paint$Join;)Landroid/graphics/Paint$Join;
    ...
    iget v1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->p:F
    ...
    iput-object p3, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->f:Landroidx/core/content/res/d;
    ...
    iput p3, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->i:F

    const/4 p3, 0x4

    iget v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->g:F
    ...
    iput p3, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->g:F
    ...
    iput p3, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->k:F
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->h:Landroidx/core/content/res/d;
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->f:Landroidx/core/content/res/d;
...
.method public b([I)Z
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->f:Landroidx/core/content/res/d;
...
.method public g(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {p0, p1, p4, p3}, Landroidx/vectordrawable/graphics/drawable/i$c;->h(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
...
.method setStrokeWidth(F)V
    ...
    iput p1, p0, Landroidx/vectordrawable/graphics/drawable/i$c;->g:F
