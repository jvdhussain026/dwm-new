...
.field b:Landroidx/vectordrawable/graphics/drawable/i;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/vectordrawable/graphics/drawable/c$c;Landroid/graphics/drawable/Drawable$Callback;Landroid/content/res/Resources;)V
    ...
    iget-object p1, p2, Landroidx/vectordrawable/graphics/drawable/c$c;->b:Landroidx/vectordrawable/graphics/drawable/i;

    const/4 v0, 0x0

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Landroidx/vectordrawable/graphics/drawable/i;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    :goto_0
    check-cast p1, Landroidx/vectordrawable/graphics/drawable/i;

    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/c$c;->b:Landroidx/vectordrawable/graphics/drawable/i;

    iget-object p1, p0, Landroidx/vectordrawable/graphics/drawable/c$c;->b:Landroidx/vectordrawable/graphics/drawable/i;

    invoke-virtual {p1}, Landroidx/vectordrawable/graphics/drawable/i;->mutate()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p3, p2, Landroidx/vectordrawable/graphics/drawable/c$c;->b:Landroidx/vectordrawable/graphics/drawable/i;
    ...
    invoke-virtual {p1, v0}, Landroidx/vectordrawable/graphics/drawable/i;->h(Z)V
    ...
    iput-object p3, p0, Landroidx/vectordrawable/graphics/drawable/c$c;->e:Lp/a;
    ...
    iget-object v1, p2, Landroidx/vectordrawable/graphics/drawable/c$c;->e:Lp/a;
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/c$c;->b:Landroidx/vectordrawable/graphics/drawable/i;

    invoke-virtual {v1, p3}, Landroidx/vectordrawable/graphics/drawable/i;->d(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/c$c;->e:Lp/a;
