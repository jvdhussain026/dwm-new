...
# instance fields
.field protected volatile a:La1/b;
...
.method public c()V
    ...
    iget-object v0, p0, Landroidx/room/h;->d:La1/c;

    invoke-interface {v0}, La1/c;->R()La1/b;

    move-result-object v0

    iget-object v1, p0, Landroidx/room/h;->e:Landroidx/room/e;

    invoke-virtual {v1, v0}, Landroidx/room/e;->m(La1/b;)V

    invoke-interface {v0}, La1/b;->k()V

    return-void
.end method

.method public d(Ljava/lang/String;)La1/f;
    .locals 1
    ...
    invoke-interface {v0, p1}, La1/b;->v(Ljava/lang/String;)La1/f;
...
.method protected abstract f(Landroidx/room/a;)La1/c;
.end method
...
.method public k()Z
    ...
    invoke-interface {v0}, La1/b;->m0()Z
...
.method public l(Landroidx/room/a;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/room/h;->f(Landroidx/room/a;)La1/c;

    move-result-object v0

    iput-object v0, p0, Landroidx/room/h;->d:La1/c;
    ...
    :goto_0
    iget-object v1, p0, Landroidx/room/h;->d:La1/c;

    invoke-interface {v1, v0}, La1/c;->setWriteAheadLoggingEnabled(Z)V
...
.method protected m(La1/b;)V
    .locals 1

    iget-object v0, p0, Landroidx/room/h;->e:Landroidx/room/e;

    invoke-virtual {v0, p1}, Landroidx/room/e;->d(La1/b;)V
...
.method public o()Z
    ...
    iget-object v0, p0, Landroidx/room/h;->a:La1/b;

    if-eqz v0, :cond_0

    invoke-interface {v0}, La1/b;->isOpen()Z
...
.method public p(La1/e;)Landroid/database/Cursor;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Landroidx/room/h;->q(La1/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public q(La1/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, La1/b;->H0(La1/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :cond_0
    iget-object p2, p0, Landroidx/room/h;->d:La1/c;

    invoke-interface {p2}, La1/c;->R()La1/b;

    move-result-object p2

    invoke-interface {p2, p1}, La1/b;->T(La1/e;)Landroid/database/Cursor;
