...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/work/impl/background/systemalarm/b;->r:Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->o:Landroid/content/Context;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->p:Ljava/util/Map;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->q:Ljava/lang/Object;
...
.method private h(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    sget-object v1, Landroidx/work/impl/background/systemalarm/b;->r:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, p1, v2}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    new-instance p1, Landroidx/work/impl/background/systemalarm/c;

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->o:Landroid/content/Context;
...
.method private i(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->q:Ljava/lang/Object;
    ...
    sget-object v2, Landroidx/work/impl/background/systemalarm/b;->r:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->p:Ljava/util/Map;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/b;->o:Landroid/content/Context;
    ...
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/b;->p:Ljava/util/Map;
    ...
    invoke-virtual {p2, v2, p1, p3}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method private j(Landroid/content/Intent;I)V
    ...
    sget-object v3, Landroidx/work/impl/background/systemalarm/b;->r:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, p1, p2}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method private k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {v0, v1, p1, p2}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Lj1/i;

    move-result-object p1

    invoke-virtual {p1}, Lj1/i;->s()V
...
.method private l(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {v0, v1, v3, v5}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3, p1}, Lq1/q;->n(Ljava/lang/String;)Lq1/p;
    ...
    invoke-virtual {p2, v1, p1, p3}, Li1/j;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v6, v3, Lq1/p;->b:Li1/s;

    invoke-virtual {v6}, Li1/s;->d()Z
    ...
    :cond_1
    :try_start_3
    invoke-virtual {v3}, Lq1/p;->a()J

    move-result-wide v5

    invoke-virtual {v3}, Lq1/p;->b()Z
    ...
    invoke-virtual {p2, v1, v2, v3}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/b;->o:Landroid/content/Context;

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Lj1/i;

    move-result-object p3

    invoke-static {p2, p3, p1, v5, v6}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Lj1/i;Ljava/lang/String;J)V
    ...
    invoke-virtual {v3, v1, v2, v4}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->o:Landroid/content/Context;

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Lj1/i;

    move-result-object v2

    invoke-static {v1, v2, p1, v5, v6}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Lj1/i;Ljava/lang/String;J)V

    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->o:Landroid/content/Context;
...
.method private m(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {v0, v1, v2, v4}, Li1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-virtual {p2}, Landroidx/work/impl/background/systemalarm/e;->g()Lj1/i;
    ...
    invoke-static {v0, v1, p1}, Landroidx/work/impl/background/systemalarm/a;->a(Landroid/content/Context;Lj1/i;Ljava/lang/String;)V
...
.method public c(Ljava/lang/String;Z)V
    ...
    invoke-interface {v1, p1, p2}, Lj1/b;->c(Ljava/lang/String;Z)V
...
.method p(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    sget-object p2, Landroidx/work/impl/background/systemalarm/b;->r:Ljava/lang/String;
    ...
    invoke-virtual {p1, p2, p3, v0}, Li1/j;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    sget-object p3, Landroidx/work/impl/background/systemalarm/b;->r:Ljava/lang/String;
    ...
    invoke-virtual {p2, p3, p1, v0}, Li1/j;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
