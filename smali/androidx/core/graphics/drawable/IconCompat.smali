...
.method public static j([BII)Landroidx/core/graphics/drawable/IconCompat;
    .locals 2
...
.method static p(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    .locals 3
...
.method private u(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    .locals 5
    ...
    invoke-static {v1, v2}, Landroidx/core/graphics/drawable/IconCompat;->d(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    :cond_1
    invoke-static {p1, v0}, Landroidx/core/graphics/drawable/IconCompat;->p(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    ...
    invoke-static {v0, v3, p1}, Landroidx/core/content/res/h;->e(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/content/Context;)V
    ...
    invoke-static {p1, v2}, Landroidx/core/graphics/drawable/IconCompat;->p(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
...
.method public t(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->z(Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->u(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public y()Landroid/graphics/drawable/Icon;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Landroidx/core/graphics/drawable/IconCompat;->z(Landroid/content/Context;)Landroid/graphics/drawable/Icon;
...
.method public z(Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    .locals 2
