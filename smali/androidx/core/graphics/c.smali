...
.method public static a(Landroid/graphics/Paint;Ljava/lang/String;)Z
    ...
    :cond_6
    invoke-static {}, Landroidx/core/graphics/c;->b()Landroidx/core/util/d;

    move-result-object v4

    const/4 v5, 0x2

    iget-object v6, v4, Landroidx/core/util/d;->a:Ljava/lang/Object;

    check-cast v6, Landroid/graphics/Rect;

    invoke-virtual {p0, v3, v2, v5, v6}, Landroid/graphics/Paint;->getTextBounds(Ljava/lang/String;IILandroid/graphics/Rect;)V

    iget-object v3, v4, Landroidx/core/util/d;->b:Ljava/lang/Object;

    check-cast v3, Landroid/graphics/Rect;

    invoke-virtual {p0, p1, v2, v0, v3}, Landroid/graphics/Paint;->getTextBounds(Ljava/lang/String;IILandroid/graphics/Rect;)V

    iget-object p0, v4, Landroidx/core/util/d;->a:Ljava/lang/Object;

    check-cast p0, Landroid/graphics/Rect;

    iget-object p1, v4, Landroidx/core/util/d;->b:Ljava/lang/Object;
...
.method private static b()Landroidx/core/util/d;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :cond_0
    iget-object v0, v1, Landroidx/core/util/d;->a:Ljava/lang/Object;

    check-cast v0, Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->setEmpty()V

    iget-object v0, v1, Landroidx/core/util/d;->b:Ljava/lang/Object;
