...
.method constructor <init>(Landroidx/core/app/l$e;)V
    ...
    iget-object v3, p1, Landroidx/core/app/l$e;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Landroidx/core/app/l$e;->L:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Landroidx/core/app/m;->b:Landroid/app/Notification$Builder;

    iget-object v2, p1, Landroidx/core/app/l$e;->S:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroidx/core/app/l$e;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroidx/core/app/l$e;->u:I
    ...
    iget-object v4, p1, Landroidx/core/app/l$e;->r:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v4}, Landroidx/core/app/m;->b(Landroidx/core/app/l$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Landroidx/core/app/l$e;->E:Landroid/os/Bundle;
    ...
    iput-object v4, p0, Landroidx/core/app/m;->d:Landroid/widget/RemoteViews;

    iget-object v4, p1, Landroidx/core/app/l$e;->J:Landroid/widget/RemoteViews;

    iput-object v4, p0, Landroidx/core/app/m;->e:Landroid/widget/RemoteViews;

    iget-object v4, p0, Landroidx/core/app/m;->b:Landroid/app/Notification$Builder;

    iget-boolean v8, p1, Landroidx/core/app/l$e;->n:Z

    invoke-virtual {v4, v8}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    if-ge v0, v3, :cond_8

    iget-object v4, p1, Landroidx/core/app/l$e;->c:Ljava/util/ArrayList;

    invoke-static {v4}, Landroidx/core/app/m;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v4

    iget-object v8, p1, Landroidx/core/app/l$e;->V:Ljava/util/ArrayList;

    invoke-static {v4, v8}, Landroidx/core/app/m;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v8, p0, Landroidx/core/app/m;->g:Landroid/os/Bundle;
    ...
    invoke-virtual {v8, v9, v4}, Landroid/os/Bundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iget-object v3, p1, Landroidx/core/app/l$e;->V:Ljava/util/ArrayList;
    ...
    :cond_9
    iget-object v0, p1, Landroidx/core/app/l$e;->V:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-object v0, p1, Landroidx/core/app/l$e;->K:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p1}, Landroidx/core/app/l$e;->g()Landroid/os/Bundle;
    ...
    iget-object v3, p1, Landroidx/core/app/l$e;->U:Landroid/graphics/drawable/Icon;
    ...
    iget-object v8, p1, Landroidx/core/app/l$e;->E:Landroid/os/Bundle;

    invoke-virtual {v3, v8}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v8, p1, Landroidx/core/app/l$e;->t:[Ljava/lang/CharSequence;
    ...
    iget-object v9, p1, Landroidx/core/app/l$e;->N:Ljava/lang/String;
    ...
    iget-boolean v8, p1, Landroidx/core/app/l$e;->C:Z

    if-eqz v8, :cond_12

    iget-object v8, p0, Landroidx/core/app/m;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Landroidx/core/app/l$e;->B:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    :cond_12
    iget-object v8, p1, Landroidx/core/app/l$e;->L:Ljava/lang/String;
    ...
    check-cast v4, Landroidx/core/app/p;

    iget-object v7, p0, Landroidx/core/app/m;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Landroidx/core/app/p;->j()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Landroidx/core/app/l$e;->R:Z
    ...
    invoke-static {v3}, Landroidx/core/app/l$d;->a(Landroidx/core/app/l$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    iget v4, p1, Landroidx/core/app/l$e;->Q:I
...
.method private b(Landroidx/core/app/l$a;)V
    ...
    invoke-virtual {p1}, Landroidx/core/app/l$a;->e()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_0
    invoke-virtual {p1}, Landroidx/core/app/l$a;->i()Ljava/lang/CharSequence;
    ...
    :goto_2
    invoke-virtual {p1}, Landroidx/core/app/l$a;->f()[Landroidx/core/app/r;
    ...
    :cond_5
    invoke-virtual {p1}, Landroidx/core/app/l$a;->g()I
    ...
    :cond_8
    invoke-virtual {p1}, Landroidx/core/app/l$a;->h()Z
...
.method private static g(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Landroidx/core/app/p;->i()Ljava/lang/String;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, v0, Landroidx/core/app/l$e;->q:Landroidx/core/app/l$i;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Landroidx/core/app/l$i;->b(Landroidx/core/app/k;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Landroidx/core/app/l$i;->t(Landroidx/core/app/k;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Landroidx/core/app/l$i;->s(Landroidx/core/app/k;)Landroid/widget/RemoteViews;
    ...
    iget-object v1, v1, Landroidx/core/app/l$e;->q:Landroidx/core/app/l$i;

    invoke-virtual {v1, p0}, Landroidx/core/app/l$i;->u(Landroidx/core/app/k;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/l$i;->a(Landroid/os/Bundle;)V
