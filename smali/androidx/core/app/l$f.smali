...
.method private x(Landroid/widget/RemoteViews;Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v3}, Landroidx/core/app/l$f;->z(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v5}, Landroidx/core/app/l$f;->y(Landroidx/core/app/l$a;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/core/app/l$i;->d(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V

    return-object v0
.end method

.method private y(Landroidx/core/app/l$a;)Landroid/widget/RemoteViews;
    .locals 6

    iget-object v0, p1, Landroidx/core/app/l$a;->k:Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, v2, v4}, Landroidx/core/app/l$i;->m(Landroidx/core/graphics/drawable/IconCompat;I)Landroid/graphics/Bitmap;
    ...
    iget-object v3, p1, Landroidx/core/app/l$a;->j:Ljava/lang/CharSequence;
    ...
    iget-object v2, p1, Landroidx/core/app/l$a;->k:Landroid/app/PendingIntent;
    ...
    iget-object p1, p1, Landroidx/core/app/l$a;->j:Ljava/lang/CharSequence;
...
.method private static z(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Landroidx/core/app/l$a;->k()Z
...
.method public s(Landroidx/core/app/k;)Landroid/widget/RemoteViews;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/core/app/l$f;->x(Landroid/widget/RemoteViews;Z)Landroid/widget/RemoteViews;
...
.method public u(Landroidx/core/app/k;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p1}, Landroidx/core/app/l$e;->h()Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v1}, Landroidx/core/app/l$e;->f()Landroid/widget/RemoteViews;
    ...
    invoke-direct {p0, v1, p1}, Landroidx/core/app/l$f;->x(Landroid/widget/RemoteViews;Z)Landroid/widget/RemoteViews;
