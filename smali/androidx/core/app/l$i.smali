.class public abstract Landroidx/core/app/l$i;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroidx/core/app/l$i;->d:Z
...
.method private e()I
    ...
    invoke-static {v0, v3, v4}, Landroidx/core/app/l$i;->f(FFF)F
...
.method static g(Ljava/lang/String;)Landroidx/core/app/l$i;
    .locals 2
    ...
    :pswitch_0
    new-instance p0, Landroidx/core/app/l$h;

    invoke-direct {p0}, Landroidx/core/app/l$h;-><init>()V

    return-object p0

    :pswitch_1
    new-instance p0, Landroidx/core/app/l$c;

    invoke-direct {p0}, Landroidx/core/app/l$c;-><init>()V

    return-object p0

    :pswitch_2
    new-instance p0, Landroidx/core/app/l$g;
    ...
    :pswitch_3
    new-instance p0, Landroidx/core/app/l$b;

    invoke-direct {p0}, Landroidx/core/app/l$b;-><init>()V

    return-object p0

    :pswitch_4
    new-instance p0, Landroidx/core/app/l$f;
...
.method private static h(Ljava/lang/String;)Landroidx/core/app/l$i;
    .locals 3
...
.method static i(Landroid/os/Bundle;)Landroidx/core/app/l$i;
    .locals 1
    ...
    invoke-static {v0}, Landroidx/core/app/l$i;->g(Ljava/lang/String;)Landroidx/core/app/l$i;
    ...
    invoke-static {p0}, Landroidx/core/app/l$i;->h(Ljava/lang/String;)Landroidx/core/app/l$i;
...
.method static j(Landroid/os/Bundle;)Landroidx/core/app/l$i;
    .locals 2

    invoke-static {p0}, Landroidx/core/app/l$i;->i(Landroid/os/Bundle;)Landroidx/core/app/l$i;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v0, p0}, Landroidx/core/app/l$i;->v(Landroid/os/Bundle;)V
    :try_end_0
...
.method private l(III)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/core/app/l$i;->n(Landroidx/core/graphics/drawable/IconCompat;II)Landroid/graphics/Bitmap;
...
.method private o(IIII)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-direct {p0, v0, p4, p2}, Landroidx/core/app/l$i;->l(III)Landroid/graphics/Bitmap;
...
.method public static p(Landroid/app/Notification;)Landroidx/core/app/l$i;
    .locals 0

    invoke-static {p0}, Landroidx/core/app/l;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/core/app/l$i;->j(Landroid/os/Bundle;)Landroidx/core/app/l$i;
...
.method public a(Landroid/os/Bundle;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/core/app/l$i;->b:Ljava/lang/CharSequence;
    ...
    :cond_1
    invoke-virtual {p0}, Landroidx/core/app/l$i;->q()Ljava/lang/String;
...
.method public abstract b(Landroidx/core/app/k;)V
.end method
...
.method public c(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object p2, p0, Landroidx/core/app/l$i;->a:Landroidx/core/app/l$e;

    invoke-virtual {p2}, Landroidx/core/app/l$e;->i()I
    ...
    iget-object v3, p2, Landroidx/core/app/l$e;->j:Landroid/graphics/Bitmap;
    ...
    iget-object v3, v3, Landroidx/core/app/l$e;->j:Landroid/graphics/Bitmap;

    invoke-virtual {v7, p2, v3}, Landroid/widget/RemoteViews;->setImageViewBitmap(ILandroid/graphics/Bitmap;)V

    if-eqz p1, :cond_6

    iget-object p1, p0, Landroidx/core/app/l$i;->a:Landroidx/core/app/l$e;

    iget-object p1, p1, Landroidx/core/app/l$e;->S:Landroid/app/Notification;
    ...
    iget-object v3, v1, Landroidx/core/app/l$e;->S:Landroid/app/Notification;

    iget v3, v3, Landroid/app/Notification;->icon:I

    invoke-virtual {v1}, Landroidx/core/app/l$e;->e()I

    move-result v1

    invoke-direct {p0, v3, p1, p2, v1}, Landroidx/core/app/l$i;->o(IIII)Landroid/graphics/Bitmap;
    ...
    iget-object p2, p2, Landroidx/core/app/l$e;->S:Landroid/app/Notification;

    iget p2, p2, Landroid/app/Notification;->icon:I

    invoke-virtual {p0, p2, v1}, Landroidx/core/app/l$i;->k(II)Landroid/graphics/Bitmap;
    ...
    iget-object p1, p2, Landroidx/core/app/l$e;->S:Landroid/app/Notification;
    ...
    iget-object v4, v3, Landroidx/core/app/l$e;->S:Landroid/app/Notification;

    iget v4, v4, Landroid/app/Notification;->icon:I

    invoke-virtual {v3}, Landroidx/core/app/l$e;->e()I

    move-result v3

    invoke-direct {p0, v4, p2, v1, v3}, Landroidx/core/app/l$i;->o(IIII)Landroid/graphics/Bitmap;
    ...
    iget-object v2, v1, Landroidx/core/app/l$e;->k:Ljava/lang/CharSequence;
    ...
    :cond_10
    iget-object p3, p0, Landroidx/core/app/l$i;->a:Landroidx/core/app/l$e;

    invoke-virtual {p3}, Landroidx/core/app/l$e;->j()J
...
.method public d(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/app/l$i;->r(Landroid/widget/RemoteViews;)V
    ...
    invoke-direct {p0}, Landroidx/core/app/l$i;->e()I
...
.method public k(II)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/core/app/l$i;->l(III)Landroid/graphics/Bitmap;
...
.method m(Landroidx/core/graphics/drawable/IconCompat;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/core/app/l$i;->n(Landroidx/core/graphics/drawable/IconCompat;II)Landroid/graphics/Bitmap;
...
.method public u(Landroidx/core/app/k;)Landroid/widget/RemoteViews;
    .locals 0
...
.method protected v(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroidx/core/app/l$i;->c:Ljava/lang/CharSequence;
...
.method public w(Landroidx/core/app/l$e;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/core/app/l$i;->a:Landroidx/core/app/l$e;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p0}, Landroidx/core/app/l$e;->O(Landroidx/core/app/l$i;)Landroidx/core/app/l$e;
