...
.field p:Landroidx/appcompat/view/menu/i;
...
.method public d(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->p:Landroidx/appcompat/view/menu/i;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->o:Landroidx/appcompat/view/menu/g;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->o:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->p:Landroidx/appcompat/view/menu/i;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->p:Landroidx/appcompat/view/menu/i;
...
.method public f(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/i;)Z
    ...
    iget-object p1, p1, Landroidx/appcompat/widget/Toolbar;->w:Landroid/view/View;
    ...
    invoke-interface {p1}, Landroidx/appcompat/view/c;->e()V

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->q:Landroidx/appcompat/widget/Toolbar;

    iget-object v0, p1, Landroidx/appcompat/widget/Toolbar;->w:Landroid/view/View;

    invoke-virtual {p1, v0}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->q:Landroidx/appcompat/widget/Toolbar;

    iget-object v0, p1, Landroidx/appcompat/widget/Toolbar;->v:Landroid/widget/ImageButton;
    ...
    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->w:Landroid/view/View;

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->a()V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->p:Landroidx/appcompat/view/menu/i;
...
.method public g(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/i;)Z
    ...
    iget-object p1, p1, Landroidx/appcompat/widget/Toolbar;->v:Landroid/widget/ImageButton;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/Toolbar;->v:Landroid/widget/ImageButton;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->p:Landroidx/appcompat/view/menu/i;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/Toolbar;->w:Landroid/view/View;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar$d;->q:Landroidx/appcompat/widget/Toolbar;

    iget v2, v1, Landroidx/appcompat/widget/Toolbar;->B:I
    ...
    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->w:Landroid/view/View;
    ...
    iget-object p2, p2, Landroidx/appcompat/widget/Toolbar;->w:Landroid/view/View;
...
.method public i(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->o:Landroidx/appcompat/view/menu/g;
