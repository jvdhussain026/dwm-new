...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, Landroidx/appcompat/widget/ActionBarContainer;->x:I
    ...
    iput-boolean v1, p0, Landroidx/appcompat/widget/ActionBarContainer;->v:Z
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/ActionBarContainer;->v:Z
...
.method public onFinishInflate()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContainer;->p:Landroid/view/View;
    ...
    :cond_1
    iget-boolean p2, p0, Landroidx/appcompat/widget/ActionBarContainer;->v:Z
    ...
    :cond_3
    iget-object p2, p0, Landroidx/appcompat/widget/ActionBarContainer;->s:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_6

    iget-object p2, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;

    invoke-virtual {p3}, Landroid/view/View;->getLeft()I

    move-result p3

    iget-object p4, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;

    invoke-virtual {p4}, Landroid/view/View;->getTop()I

    move-result p4

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getRight()I

    move-result v0

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;
    ...
    :cond_4
    iget-object p2, p0, Landroidx/appcompat/widget/ActionBarContainer;->r:Landroid/view/View;
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/ActionBarContainer;->r:Landroid/view/View;
    ...
    :cond_6
    iput-boolean v1, p0, Landroidx/appcompat/widget/ActionBarContainer;->w:Z

    if-eqz v1, :cond_7

    iget-object p2, p0, Landroidx/appcompat/widget/ActionBarContainer;->t:Landroid/graphics/drawable/Drawable;
...
.method public onMeasure(II)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarContainer;->p:Landroid/view/View;
...
.method public setPrimaryBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarContainer;->q:Landroid/view/View;
...
.method public setStackedBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarContainer;->p:Landroid/view/View;
...
.method public setTabContainer(Landroidx/appcompat/widget/r0;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarContainer;->p:Landroid/view/View;
...
.method public setTransitioning(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/ActionBarContainer;->o:Z
