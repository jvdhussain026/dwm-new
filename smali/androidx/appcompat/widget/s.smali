...
.method b()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/s;->b:Landroid/graphics/Bitmap;
...
.method c(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v2}, Landroidx/appcompat/widget/y0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/y0;

    move-result-object p1

    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/y0;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/s;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/widget/y0;->h(I)Landroid/graphics/drawable/Drawable;
...
.method d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v1, v2}, Landroidx/appcompat/widget/s$a;->a(Landroid/graphics/drawable/LayerDrawable;Landroid/graphics/drawable/LayerDrawable;I)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/s;->a()Landroid/graphics/drawable/shapes/Shape;
