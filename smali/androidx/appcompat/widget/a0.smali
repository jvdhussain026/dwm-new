...
.field private b:Landroidx/appcompat/widget/w0;

.field private c:Landroidx/appcompat/widget/w0;
...
.field private g:Landroidx/appcompat/widget/w0;

.field private h:Landroidx/appcompat/widget/w0;
...
.method private C(Landroid/content/Context;Landroidx/appcompat/widget/y0;)V
    .locals 10
    ...
    invoke-virtual {p2, v5, v3}, Landroidx/appcompat/widget/y0;->k(II)I
    ...
    invoke-virtual {p2, v5}, Landroidx/appcompat/widget/y0;->s(I)Z
    ...
    invoke-virtual {p2, v6}, Landroidx/appcompat/widget/y0;->s(I)Z
    ...
    invoke-direct {v9, p0, v6, v8, p1}, Landroidx/appcompat/widget/a0$a;-><init>(Landroidx/appcompat/widget/a0;IILjava/lang/ref/WeakReference;)V

    :try_start_0
    iget p1, p0, Landroidx/appcompat/widget/a0;->j:I

    invoke-virtual {p2, v5, p1, v9}, Landroidx/appcompat/widget/y0;->j(IILandroidx/core/content/res/h$f;)Landroid/graphics/Typeface;
    ...
    :goto_3
    invoke-static {p1, v0, v6}, Landroidx/appcompat/widget/a0$g;->a(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p2, v5}, Landroidx/appcompat/widget/y0;->o(I)Ljava/lang/String;
    ...
    :cond_d
    invoke-static {p1, p2, v4}, Landroidx/appcompat/widget/a0$g;->a(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
...
.method private a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/j;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;[I)V

    :cond_0
    return-void
.end method

.method private static d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/w0;
    .locals 0
...
.method private y(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_6
    invoke-static {p1, p3, p2, p6, p4}, Landroidx/appcompat/widget/a0$c;->b(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private z()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->h:Landroidx/appcompat/widget/w0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/w0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/w0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/w0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/w0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/w0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/w0;
...
.method b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/w0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/w0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/w0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/w0;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/w0;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/w0;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;)V

    aget-object v3, v0, v1

    iget-object v4, p0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/w0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/w0;

    invoke-direct {p0, v0, v3}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;)V

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/w0;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/w0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/w0;

    invoke-direct {p0, v2, v3}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;)V

    aget-object v0, v0, v1

    iget-object v1, p0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/w0;

    invoke-direct {p0, v0, v1}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/w0;)V
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    invoke-static/range {v0 .. v6}, Landroidx/core/view/y;->p0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-static {v10, v11, v1}, Landroidx/appcompat/widget/a0;->d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/w0;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/w0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/w0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/w0;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/w0;
    ...
    invoke-virtual {v13, v2}, Landroidx/appcompat/widget/y0;->s(I)Z

    move-result v3

    if-eqz v3, :cond_4

    invoke-virtual {v13, v2, v12}, Landroidx/appcompat/widget/y0;->n(II)I

    move-result v2

    invoke-static {v10, v11, v2}, Landroidx/appcompat/widget/a0;->d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/w0;

    move-result-object v2

    iput-object v2, v7, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/w0;
    ...
    iput-object v2, v7, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/w0;
    ...
    sget-object v6, Lf/j;->E2:[I

    invoke-static {v10, v0, v6}, Landroidx/appcompat/widget/y0;->t(Landroid/content/Context;I[I)Landroidx/appcompat/widget/y0;
    ...
    invoke-virtual {v0, v6, v12}, Landroidx/appcompat/widget/y0;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {v7, v10, v0}, Landroidx/appcompat/widget/a0;->C(Landroid/content/Context;Landroidx/appcompat/widget/y0;)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/y0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v13}, Landroidx/appcompat/widget/y0;->s(I)Z

    move-result v18

    if-eqz v18, :cond_8

    invoke-virtual {v0, v13}, Landroidx/appcompat/widget/y0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v14}, Landroidx/appcompat/widget/y0;->s(I)Z

    move-result v19

    if-eqz v19, :cond_a

    invoke-virtual {v0, v14}, Landroidx/appcompat/widget/y0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/y0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v12}, Landroidx/appcompat/widget/y0;->s(I)Z
    ...
    invoke-virtual {v0, v12, v3}, Landroidx/appcompat/widget/y0;->a(IZ)Z
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/y0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v12, v11}, Landroidx/appcompat/widget/y0;->f(II)I

    move-result v12

    if-nez v12, :cond_15

    iget-object v11, v7, Landroidx/appcompat/widget/a0;->a:Landroid/widget/TextView;
    ...
    invoke-virtual {v7, v6}, Landroidx/appcompat/widget/a0;->s(Z)V
    ...
    iget v4, v7, Landroidx/appcompat/widget/a0;->j:I
    ...
    invoke-static {v0, v3}, Landroidx/appcompat/widget/a0$f;->d(Landroid/widget/TextView;Ljava/lang/String;)Z
    ...
    invoke-static {v5}, Landroidx/appcompat/widget/a0$e;->a(Ljava/lang/String;)Landroid/os/LocaleList;
    ...
    invoke-virtual {v0, v1, v9}, Landroidx/appcompat/widget/c0;->o(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2}, Landroidx/appcompat/widget/a0$f;->a(Landroid/widget/TextView;)I
    ...
    invoke-virtual {v2}, Landroidx/appcompat/widget/c0;->g()I

    move-result v2

    iget-object v3, v7, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/c0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/c0;->f()I

    move-result v3

    iget-object v4, v7, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/c0;

    invoke-virtual {v4}, Landroidx/appcompat/widget/c0;->h()I

    move-result v4

    const/4 v5, 0x0

    invoke-static {v0, v2, v3, v4, v5}, Landroidx/appcompat/widget/a0$f;->b(Landroid/widget/TextView;IIII)V
    ...
    invoke-static {v2, v0, v5}, Landroidx/appcompat/widget/a0$f;->c(Landroid/widget/TextView;[II)V

    :cond_20
    :goto_c
    sget-object v0, Lf/j;->g0:[I

    invoke-static {v10, v1, v0}, Landroidx/appcompat/widget/y0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/y0;
    ...
    invoke-virtual {v8, v0, v1}, Landroidx/appcompat/widget/y0;->n(II)I
    ...
    invoke-virtual {v8, v0, v1}, Landroidx/appcompat/widget/y0;->k(II)I

    move-result v0

    const/4 v2, 0x0

    invoke-static {v0, v2}, Landroidx/appcompat/widget/g0;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v8, v0, v1}, Landroidx/appcompat/widget/y0;->f(II)I

    move-result v0

    sget v2, Lf/j;->w0:I

    invoke-virtual {v8, v2, v1}, Landroidx/appcompat/widget/y0;->f(II)I

    move-result v2

    sget v3, Lf/j;->x0:I

    invoke-virtual {v8, v3, v1}, Landroidx/appcompat/widget/y0;->f(II)I
    ...
    iget-object v4, v7, Landroidx/appcompat/widget/a0;->a:Landroid/widget/TextView;
...
.method q(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, v1}, Landroidx/appcompat/widget/y0;->s(I)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {p2, v1}, Landroidx/appcompat/widget/y0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p2, v1, v3}, Landroidx/appcompat/widget/y0;->f(II)I
    ...
    :cond_4
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/a0;->C(Landroid/content/Context;Landroidx/appcompat/widget/y0;)V
...
.method r(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p1}, La0/a;->f(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;)V
...
.method w(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/a0;->h:Landroidx/appcompat/widget/w0;
