...
.field protected q:Landroidx/appcompat/view/menu/g;
...
.field protected w:Landroidx/appcompat/view/menu/n;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->r:Landroid/view/LayoutInflater;
...
.method protected a(Landroid/view/View;I)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->w:Landroidx/appcompat/view/menu/n;
...
.method public abstract b(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/n$a;)V
.end method

.method public c(Landroidx/appcompat/view/menu/g;Z)V
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->t:Landroidx/appcompat/view/menu/m$a;
...
.method public d(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->w:Landroidx/appcompat/view/menu/n;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->q:Landroidx/appcompat/view/menu/g;
...
.method public h(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->t:Landroidx/appcompat/view/menu/m$a;
...
.method public i(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->s:Landroid/view/LayoutInflater;

    iput-object p2, p0, Landroidx/appcompat/view/menu/b;->q:Landroidx/appcompat/view/menu/g;

    return-void
.end method

.method public j(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/n$a;
    .locals 3

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->r:Landroid/view/LayoutInflater;
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->q:Landroidx/appcompat/view/menu/g;
...
.method public n(Landroidx/appcompat/view/menu/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {p0, p3}, Landroidx/appcompat/view/menu/b;->j(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/n$a;

    move-result-object p2

    :goto_0
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/view/menu/b;->b(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/n$a;)V
...
.method public o(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/n;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->w:Landroidx/appcompat/view/menu/n;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/b;->d(Z)V
