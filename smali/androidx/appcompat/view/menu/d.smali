...
.field private final z:Landroidx/appcompat/widget/m0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->v:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->w:Ljava/util/List;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->x:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->y:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->z:Landroidx/appcompat/widget/m0;

    const/4 v0, 0x0

    iput v0, p0, Landroidx/appcompat/view/menu/d;->A:I

    iput v0, p0, Landroidx/appcompat/view/menu/d;->B:I

    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->p:Landroid/content/Context;

    iput-object p2, p0, Landroidx/appcompat/view/menu/d;->C:Landroid/view/View;

    iput p3, p0, Landroidx/appcompat/view/menu/d;->r:I

    iput p4, p0, Landroidx/appcompat/view/menu/d;->s:I

    iput-boolean p5, p0, Landroidx/appcompat/view/menu/d;->t:Z

    iput-boolean v0, p0, Landroidx/appcompat/view/menu/d;->J:Z
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->u:Landroid/os/Handler;
...
.method private A(Landroidx/appcompat/view/menu/g;)I
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->w:Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->w:Ljava/util/List;
...
.method private D()I
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->C:Landroid/view/View;
...
.method private F(Landroidx/appcompat/view/menu/g;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->p:Landroid/content/Context;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->p:Landroid/content/Context;
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->z()Landroidx/appcompat/widget/n0;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/l0;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/l0;->F(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->B:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/l0;->G(I)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->w:Ljava/util/List;
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/n0;->V(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/n0;->S(Ljava/lang/Object;)V
    ...
    :goto_2
    iput v8, p0, Landroidx/appcompat/view/menu/d;->E:I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/l0;->D(Landroid/view/View;)V
    ...
    iget-object v12, p0, Landroidx/appcompat/view/menu/d;->C:Landroid/view/View;
    ...
    iget v12, p0, Landroidx/appcompat/view/menu/d;->B:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/d;->C:Landroid/view/View;
    ...
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/d;->B:I
    ...
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/l0;->f(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/l0;->N(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/l0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/l0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/l0;->H(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/d$d;-><init>(Landroidx/appcompat/widget/n0;Landroidx/appcompat/view/menu/g;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->w:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/l0;->a()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/l0;->j()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/n0;
    .locals 5

    new-instance v0, Landroidx/appcompat/widget/n0;

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->p:Landroid/content/Context;

    iget v2, p0, Landroidx/appcompat/view/menu/d;->r:I

    iget v3, p0, Landroidx/appcompat/view/menu/d;->s:I

    const/4 v4, 0x0

    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/n0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->z:Landroidx/appcompat/widget/m0;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->U(Landroidx/appcompat/widget/m0;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/l0;->L(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/l0;->K(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->C:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/l0;->D(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->B:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/l0;->G(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/l0;->J(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/l0;->I(I)V
...
.method public a()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->v:Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->M:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->M:Landroid/view/ViewTreeObserver;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->x:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->y:Landroid/view/View$OnAttachStateChangeListener;
...
.method public b()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/n0;

    invoke-virtual {v0}, Landroidx/appcompat/widget/l0;->b()Z
...
.method public c(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/n0;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/n0;->T(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/n0;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/l0;->E(I)V
    ...
    :goto_0
    iput v1, p0, Landroidx/appcompat/view/menu/d;->E:I

    if-nez v0, :cond_7

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->dismiss()V

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->L:Landroidx/appcompat/view/menu/m$a;

    if-eqz p2, :cond_4

    const/4 v0, 0x1

    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/m$a;->c(Landroidx/appcompat/view/menu/g;Z)V

    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->M:Landroid/view/ViewTreeObserver;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->x:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {p1, p2}, Landroid/view/ViewTreeObserver;->removeGlobalOnLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->M:Landroid/view/ViewTreeObserver;

    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->D:Landroid/view/View;

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->y:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {p1, p2}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->N:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->w:Ljava/util/List;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/n0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/l0;->b()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/n0;
...
.method public h(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->L:Landroidx/appcompat/view/menu/m$a;
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->L:Landroidx/appcompat/view/menu/m$a;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/n0;

    invoke-virtual {v4}, Landroidx/appcompat/widget/l0;->b()Z
...
.method public p(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->C:Landroid/view/View;
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/d;->B:I
...
.method public r(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/d;->J:Z
...
.method public t(I)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/d;->F:Z
...
.method public u(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->N:Landroid/widget/PopupWindow$OnDismissListener;
