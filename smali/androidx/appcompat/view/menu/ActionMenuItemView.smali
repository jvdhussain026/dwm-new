...
.field u:Landroidx/appcompat/view/menu/i;

.field private v:Ljava/lang/CharSequence;

.field private w:Landroid/graphics/drawable/Drawable;

.field x:Landroidx/appcompat/view/menu/g$b;

.field private y:Landroidx/appcompat/widget/j0;

.field z:Landroidx/appcompat/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->A:Z
    ...
    iput p2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->C:I
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->D:I
...
.method private r()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->v:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->w:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->u:Landroidx/appcompat/view/menu/i;
    ...
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->A:Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->v:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->u:Landroidx/appcompat/view/menu/i;
    ...
    :goto_3
    invoke-static {p0, v1}, Landroidx/appcompat/widget/b1;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public f(Landroidx/appcompat/view/menu/i;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->u:Landroidx/appcompat/view/menu/i;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->y:Landroidx/appcompat/widget/j0;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->y:Landroidx/appcompat/widget/j0;
...
.method public i()Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/b0;->getText()Ljava/lang/CharSequence;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->x:Landroidx/appcompat/view/menu/g$b;
...
.method protected onMeasure(II)V
    ...
    iget v3, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->C:I
    ...
    :cond_1
    iget p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->C:I
    ...
    iget v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->C:I
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->w:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->w:Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->y:Landroidx/appcompat/widget/j0;
...
.method public setExpandedFormat(Z)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->B:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->B:Z

    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->u:Landroidx/appcompat/view/menu/i;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->w:Landroid/graphics/drawable/Drawable;
    ...
    iget v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->E:I
    ...
    invoke-virtual {p0, p1, v0, v0, v0}, Landroidx/appcompat/widget/b0;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setItemInvoker(Landroidx/appcompat/view/menu/g$b;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->x:Landroidx/appcompat/view/menu/g$b;
...
.method public setPopupCallback(Landroidx/appcompat/view/menu/ActionMenuItemView$b;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->z:Landroidx/appcompat/view/menu/ActionMenuItemView$b;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->v:Ljava/lang/CharSequence;
