...
.field private static final h:Lp/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lp/g<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/i;->b:[Ljava/lang/Class;
    ...
    sput-object v0, Landroidx/appcompat/app/i;->c:[I
    ...
    sput-object v0, Landroidx/appcompat/app/i;->d:[I
    ...
    sput-object v0, Landroidx/appcompat/app/i;->e:[I
    ...
    sput-object v0, Landroidx/appcompat/app/i;->f:[I
    ...
    sput-object v0, Landroidx/appcompat/app/i;->g:[Ljava/lang/String;

    new-instance v0, Lp/g;

    invoke-direct {v0}, Lp/g;-><init>()V

    sput-object v0, Landroidx/appcompat/app/i;->h:Lp/g;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/y;->s0(Landroid/view/View;Z)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/y;->u0(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2, p3}, Landroidx/core/view/y;->H0(Landroid/view/View;Z)V
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroidx/core/view/y;->Q(Landroid/view/View;)Z
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/i;->h:Lp/g;

    invoke-virtual {v0, p2}, Lp/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v1}, Lp/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :goto_0
    sget-object v3, Landroidx/appcompat/app/i;->g:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/i;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/i;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
...
.method protected p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d0;
    .locals 1
...
.method final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/i;->u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/i;->q(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/k;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d0;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/t;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/y;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/o;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/b0;

    move-result-object p5

    :goto_2
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/i;->v(Landroid/view/View;Ljava/lang/String;)V
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/u;
    ...
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/i;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, p5, p4}, Landroidx/appcompat/app/i;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    invoke-direct {p0, p1, p5, p4}, Landroidx/appcompat/app/i;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
