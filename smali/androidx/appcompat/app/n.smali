...
.field final C:Landroidx/core/view/f0;

.field final D:Landroidx/core/view/h0;
...
.field f:Landroidx/appcompat/widget/f0;

.field g:Landroidx/appcompat/widget/ActionBarContextView;

.field h:Landroid/view/View;

.field i:Landroidx/appcompat/widget/r0;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v0, p0, Landroidx/appcompat/app/n;->B:Landroidx/core/view/f0;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/n;->C:Landroidx/core/view/f0;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/n;->D:Landroidx/core/view/h0;
...
.method private C(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/app/n;->z(Landroid/view/View;)Landroidx/appcompat/widget/f0;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/app/n;->f:Landroidx/appcompat/widget/f0;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/n;->f:Landroidx/appcompat/widget/f0;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/f0;->getContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/app/n;->a:Landroid/content/Context;

    iget-object p1, p0, Landroidx/appcompat/app/n;->f:Landroidx/appcompat/widget/f0;

    invoke-interface {p1}, Landroidx/appcompat/widget/f0;->q()I
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/app/n;->G(Z)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/app/n;->H(Z)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/app/n;->F(F)V
...
.method private G(Z)V
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/widget/f0;->i(Landroidx/appcompat/widget/r0;)V

    iget-object p1, p0, Landroidx/appcompat/app/n;->e:Landroidx/appcompat/widget/ActionBarContainer;

    iget-object v0, p0, Landroidx/appcompat/app/n;->i:Landroidx/appcompat/widget/r0;
    ...
    :goto_0
    invoke-virtual {p0}, Landroidx/appcompat/app/n;->A()I
    ...
    :goto_3
    invoke-interface {v0, v3}, Landroidx/appcompat/widget/f0;->t(Z)V
...
.method private L(Z)V
    ...
    invoke-static {v0, v1, v2}, Landroidx/appcompat/app/n;->v(ZZZ)Z
...
.method private z(Landroid/view/View;)Landroidx/appcompat/widget/f0;
    .locals 3
...
.method public A()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/f0;->m()I
...
.method public D(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/app/n;->E(II)V
...
.method public E(II)V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/f0;->q()I
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/app/n;->f:Landroidx/appcompat/widget/f0;
    ...
    invoke-interface {v1, p1}, Landroidx/appcompat/widget/f0;->k(I)V
...
.method public F(F)V
    ...
    invoke-static {v0, p1}, Landroidx/core/view/y;->z0(Landroid/view/View;F)V
...
.method public I(Z)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/f0;->p(Z)V
...
.method public e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/app/n;->y:Landroidx/appcompat/view/h;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/n;->y:Landroidx/appcompat/view/h;
...
.method public g()Z
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/f0;->j()Z
...
.method public r(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/app/n;->y:Landroidx/appcompat/view/h;
...
.method public t(Landroidx/appcompat/view/b$a;)Landroidx/appcompat/view/b;
    ...
    invoke-direct {v0, p0, v1, p1}, Landroidx/appcompat/app/n$d;-><init>(Landroidx/appcompat/app/n;Landroid/content/Context;Landroidx/appcompat/view/b$a;)V
...
.method public u(Z)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/app/n;->K()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, Landroidx/appcompat/app/n;->B()V

    :goto_0
    invoke-direct {p0}, Landroidx/appcompat/app/n;->J()Z
    ...
    invoke-interface {p1, v1, v4, v5}, Landroidx/appcompat/widget/f0;->n(IJ)Landroidx/core/view/e0;

    move-result-object p1

    iget-object v0, p0, Landroidx/appcompat/app/n;->g:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {v0, v3, v6, v7}, Landroidx/appcompat/widget/ActionBarContextView;->f(IJ)Landroidx/core/view/e0;
    ...
    invoke-interface {p1, v3, v6, v7}, Landroidx/appcompat/widget/f0;->n(IJ)Landroidx/core/view/e0;

    move-result-object v0

    iget-object p1, p0, Landroidx/appcompat/app/n;->g:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {p1, v2, v4, v5}, Landroidx/appcompat/widget/ActionBarContextView;->f(IJ)Landroidx/core/view/e0;
    ...
    invoke-interface {p1, v1}, Landroidx/appcompat/widget/f0;->o(I)V
    ...
    invoke-interface {p1, v3}, Landroidx/appcompat/widget/f0;->o(I)V
...
.method w()V
    ...
    iget-object v0, p0, Landroidx/appcompat/app/n;->o:Landroidx/appcompat/view/b$a;

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroidx/appcompat/app/n;->n:Landroidx/appcompat/view/b;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/b$a;->a(Landroidx/appcompat/view/b;)V

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/appcompat/app/n;->n:Landroidx/appcompat/view/b;

    iput-object v0, p0, Landroidx/appcompat/app/n;->o:Landroidx/appcompat/view/b$a;
...
.method public x(Z)V
    ...
    iget-object v1, p0, Landroidx/appcompat/app/n;->D:Landroidx/core/view/h0;
    ...
    iget-object p1, p0, Landroidx/appcompat/app/n;->B:Landroidx/core/view/f0;
    ...
    invoke-interface {p1, v0}, Landroidx/core/view/f0;->b(Landroid/view/View;)V
...
.method public y(Z)V
    ...
    invoke-virtual {v2, v1}, Landroidx/core/view/e0;->m(F)Landroidx/core/view/e0;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/app/n;->D:Landroidx/core/view/h0;

    invoke-virtual {v2, v3}, Landroidx/core/view/e0;->k(Landroidx/core/view/h0;)Landroidx/core/view/e0;

    invoke-virtual {p1, v2}, Landroidx/appcompat/view/h;->c(Landroidx/core/view/e0;)Landroidx/appcompat/view/h;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/view/e0;->m(F)Landroidx/core/view/e0;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/n;->C:Landroidx/core/view/f0;

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/h;->g(Landroidx/core/view/f0;)Landroidx/appcompat/view/h;

    iput-object p1, p0, Landroidx/appcompat/app/n;->y:Landroidx/appcompat/view/h;
    ...
    :cond_5
    iget-object p1, p0, Landroidx/appcompat/app/n;->C:Landroidx/core/view/f0;
